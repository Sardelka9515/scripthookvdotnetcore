...
namespace GTA.NaturalMotion
{
    ...
    public sealed class ApplyImpulseHelper : CustomHelper
    {
        ...
        public Vector3 Impulse
        {
            ...
            {
                SetArgument("impulse",
                    Vector3.Clamp(value, new Vector3(-4500.0f, -4500.0f, -4500.0f),
                        new Vector3(4500.0f, 4500.0f, 4500.0f)));
            }
        }
    ...
    public sealed class ApplyBulletImpulseHelper : CustomHelper
    {
        ...
        public Vector3 Impulse
        {
            ...
            {
                SetArgument("impulse",
                    Vector3.Clamp(value, new Vector3(-1000.0f, -1000.0f, -1000.0f),
    ...
    public sealed class ForceToBodyPartHelper : CustomHelper
    {
        ...
        public Vector3 Force
        {
            ...
            {
                SetArgument("force",
                    Vector3.Clamp(value, new Vector3(-100000.0f, -100000.0f, -100000.0f),
    ...
    public sealed class BodyBalanceHelper : CustomHelper
    {
        ...
        public Vector3 AngVelThreshold
        {
            set
            {
                SetArgument("angVelThreshold",
                    Vector3.Clamp(value, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(40.0f, 40.0f, 40.0f)));
            }
        }
    ...
    public sealed class InjuredOnGroundHelper : CustomHelper
    {
        ...
        public Vector3 Injury1LocalNormal
        {
            set
            {
                SetArgument("injury1LocalNormal",
                    Vector3.Clamp(value, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(1.0f, 1.0f, 1.0f)));
            }
        }
        ...
        public Vector3 Injury2LocalNormal
        {
            set
            {
                SetArgument("injury2LocalNormal",
                    Vector3.Clamp(value, new Vector3(0.0f, 0.0f, 0.0f), new Vector3(1.0f, 1.0f, 1.0f)));
            }
        }
        ...
        public Vector3 BulletVel
        {
            set
            {
                SetArgument("bulletVel",
                    Vector3.Clamp(value, new Vector3(-2000.0f, -2000.0f, -2000.0f),
