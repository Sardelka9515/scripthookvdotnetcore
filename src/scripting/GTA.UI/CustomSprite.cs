...
namespace GTA.UI
{
    ...
    public class CustomSprite : ISpriteElement
    {
        ...
        public CustomSprite(string filename, SizeF size, PointF position, Color color, float rotation, bool centered)
        {
            ...
            {
                _id = NativeMemory.CreateTexture(filename);
        ...
        void InternalDraw(SizeF offset, float screenWidth, float screenHeight)
        {
            ...
            int frameCount = Call<int>(Hash.GET_FRAME_COUNT);
            ...
            NativeMemory.DrawTexture(_id, _indexes[_id]++, _globalLevel++, 100, scaleX, scaleY / aspectRatio, 0.5f,
                0.5f, positionX, positionY, Rotation * 0.00277777778f, aspectRatio, Color.R / 255f, Color.G / 255f,
