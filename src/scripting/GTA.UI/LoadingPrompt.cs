...
namespace GTA.UI
{
    ...
    public static class LoadingPrompt
    {
        ...
        /// </summary>
        public static bool IsActive => Call<bool>(Hash.BUSYSPINNER_IS_ON);
            ...
            LoadingSpinnerType spinnerType = LoadingSpinnerType.RegularClockwise)
        {
            ...
            if (loadingText == null)
            {
                Function.Call(Hash.BEGIN_TEXT_COMMAND_BUSYSPINNER_ON, NullString);
            }
            else
            {
                Function.Call(Hash.BEGIN_TEXT_COMMAND_BUSYSPINNER_ON, StringString);
                Call(Hash.ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME, loadingText);
            }

            Call(Hash.END_TEXT_COMMAND_BUSYSPINNER_ON, spinnerType);
        }
