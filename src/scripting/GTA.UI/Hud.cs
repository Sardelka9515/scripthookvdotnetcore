...
namespace GTA.UI
{
    ...
    public static class Hud
    {
        ...
        {
            return Call<bool>(Hash.IS_HUD_COMPONENT_ACTIVE, component);
        }
        ...
        {
            Call(Hash.SHOW_HUD_COMPONENT_THIS_FRAME, component);
        }
        ...
        {
            Call(Hash.HIDE_HUD_COMPONENT_THIS_FRAME, component);
        }
        ...
        {
            Call(Hash.SET_MOUSE_CURSOR_THIS_FRAME);
        }
        ...
        {
            get => (CursorSprite)NativeMemory.CursorSprite;
            set => Call(Hash.SET_MOUSE_CURSOR_STYLE, value);
        }
        ...
        {
            get => !Call<bool>(Hash.IS_HUD_HIDDEN);
            set => Call(Hash.DISPLAY_HUD, value);
        }
        ...
        {
            get => !Call<bool>(Hash.IS_RADAR_HIDDEN);
            set => Call(Hash.DISPLAY_RADAR, value);
        }
        ...
        {
            set => Call(Hash.SET_RADAR_ZOOM, value);
        }
    }
}