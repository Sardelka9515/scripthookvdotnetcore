...
namespace GTA
{
    public sealed class Camera : PoolObject, ISpatial
    {
        ...
        {
            get => NativeMemory.GetCameraAddress(Handle);
        }
        ...
        IntPtr MatrixAddress
        {
            get
            {
                ...
                return address != IntPtr.Zero
                    ? (
                        (NativeMemory.ReadByte(address + 0x220) & 1) == 0 ? address + 0x30 : address + 0x110)
                    : IntPtr.Zero;
            }
        }
        ...
        {
            get => Call<bool>(Hash.IS_CAM_ACTIVE, Handle);
            set => Call(Hash.SET_CAM_ACTIVE, Handle, value);
        }
        ...
        public Matrix Matrix
        {
            get
            {
                ...
                return address != IntPtr.Zero ? new Matrix(NativeMemory.ReadMatrix(address)) : new Matrix();
            }
        }
        ...
        {
            get => Call<Vector3>(Hash.GET_CAM_COORD, Handle);
            set => Call(Hash.SET_CAM_COORD, Handle, value.X, value.Y, value.Z);
        }
        ...
        {
            get => Call<Vector3>(Hash.GET_CAM_ROT, Handle, 2);
            set => Call(Hash.SET_CAM_ROT, Handle, value.X, value.Y, value.Z, 2);
        }
        ...
        public Vector3 Direction
        {
            ...
            set
            {
                ...
                Rotation = new Vector3((float)(System.Math.Atan2(vector3.X, vector3.Y) * 57.295779513082323),
                    Rotation.Y, (float)(System.Math.Atan2(value.X, value.Y) * -57.295779513082323));
            }
        }
        ...
        public Vector3 UpVector
        {
            get
            {
                IntPtr address = MatrixAddress;
                return address != IntPtr.Zero
                    ? new Vector3(NativeMemory.ReadVector3(address + 0x20))
                    : Vector3.RelativeTop;
            }
        }
        ...
        public Vector3 RightVector
        {
            ...
            {
                IntPtr address = MatrixAddress;
                return address != IntPtr.Zero ? new Vector3(NativeMemory.ReadVector3(address)) : Vector3.RelativeRight;
            }
        }
        ...
        public Vector3 ForwardVector
        {
            get
            {
                IntPtr address = MatrixAddress;
                return address != IntPtr.Zero
                    ? new Vector3(NativeMemory.ReadVector3(address + 0x10))
                    : Vector3.RelativeFront;
            }
        }
        ...
        {
            get => Call<float>(Hash.GET_CAM_FAR_CLIP, Handle);
            set => Call(Hash.SET_CAM_FAR_CLIP, Handle, value);
        }
        ...
        {
            get => Call<float>(Hash.GET_CAM_NEAR_CLIP, Handle);
            set => Call(Hash.SET_CAM_NEAR_CLIP, Handle, value);
        }
        ...
        {
            get => Call<float>(Hash.GET_CAM_FOV, Handle);
            set => Call(Hash.SET_CAM_FOV, Handle, value);
        }
        ...
        {
            get => Call<float>(Hash.GET_CAM_FAR_DOF, Handle);
            set => Call(Hash.SET_CAM_FAR_DOF, Handle, value);
        }
        ...
        {
            set => Call(Hash.SET_CAM_NEAR_DOF, Handle, value);
        }
        ...
        {
            set => Call(Hash.SET_CAM_MOTION_BLUR_STRENGTH, Handle, value);
        }
        ...
        {
            set => Call(Hash.SET_CAM_DOF_STRENGTH, Handle, value);
        }
        ...
        {
            Call(Hash.SHAKE_CAM, Handle, shakeNames[(int)shakeType], amplitude);
        }
        ...
        {
            Call(Hash.STOP_CAM_SHAKING, Handle, true);
        }
        ...
        {
            get => Call<bool>(Hash.IS_CAM_SHAKING, Handle);
        }
        ...
        {
            set => Call(Hash.SET_CAM_SHAKE_AMPLITUDE, Handle, value);
        }
        ...
        {
            Call(Hash.POINT_CAM_AT_ENTITY, Handle, target.Handle, offset.X, offset.Y, offset.Z, true);
        }
        ...
        {
            Call(Hash.POINT_CAM_AT_PED_BONE, Handle, target.Owner.Handle, target, offset.X, offset.Y, offset.Z, true);
        }
        ...
        {
            Call(Hash.POINT_CAM_AT_COORD, Handle, target.X, target.Y, target.Z);
        }
        ...
        {
            Call(Hash.STOP_CAM_POINTING, Handle);
        }
        ...
        {
            Call(Hash.SET_CAM_ACTIVE_WITH_INTERP, to.Handle, Handle, duration, easePosition, easeRotation);
        }
        ...
        {
            get => Call<bool>(Hash.IS_CAM_INTERPOLATING, Handle);
        }
        ...
        {
            Call(Hash.ATTACH_CAM_TO_ENTITY, Handle, entity.Handle, offset.X, offset.Y, offset.Z, true);
        }
        ...
        {
            Call(Hash.ATTACH_CAM_TO_PED_BONE, Handle, pedBone.Owner.Handle, pedBone, offset.X, offset.Y, offset.Z,
                true);
        }
        ...
        {
            Call(Hash.DESTROY_CAM, Handle, 0);
        }
        ...
        {
            return Call<bool>(Hash.DOES_CAM_EXIST, Handle);
        }
