...
namespace GTA
{
    ...
    public struct ShapeTestHandle : IEquatable<ShapeTestHandle>, INativeValue
    {
        ...
        public ShapeTestStatus GetResult(out ShapeTestResult result)
        {
            ...
            unsafe
            {
                shapeTestStatus = Call<ShapeTestStatus>(Hash.GET_SHAPE_TEST_RESULT, Handle, &hitSomethingArg,
                    &hitPositionArg, &surfaceNormalArg, &guidHandleArg);
            }
        ...
        public ShapeTestStatus GetResultIncludingMaterial(out ShapeTestResult result, out MaterialHash materialHash)
        {
            ...
            unsafe
            {
                shapeTestStatus = Call<ShapeTestStatus>(Hash.GET_SHAPE_TEST_RESULT_INCLUDING_MATERIAL, Handle,
                    &hitSomethingArg, &hitPositionArg, &surfaceNormalArg, &materialHashArg, &guidHandleArg);
            }
