...
namespace GTA
{
    public sealed class Checkpoint : PoolObject
    {
        ...
        /// </summary>
        public IntPtr MemoryAddress => NativeMemory.GetCheckpointAddress(Handle);
        ...
        public Vector3 Position
        {
            get
            {
                ...
                return new Vector3(NativeMemory.ReadVector3(memoryAddress));
            }
            set
            {
                IntPtr memoryAddress = MemoryAddress;
                ...
                NativeMemory.WriteVector3(memoryAddress, value.ToArray());
            }
        }
        ...
        public Vector3 TargetPosition
        {
            get
            {
                ...
                return new Vector3(NativeMemory.ReadVector3(memoryAddress + 16));
            }
            set
            {
                IntPtr memoryAddress = MemoryAddress;
                ...
                NativeMemory.WriteVector3(memoryAddress + 16, value.ToArray());
            }
        }
        ...
        public CheckpointIcon Icon
        {
            get
            {
                ...
                return (CheckpointIcon)NativeMemory.ReadInt32(memoryAddress + 56);
            }
            set
            {
                IntPtr memoryAddress = MemoryAddress;
                ...
                NativeMemory.WriteInt32(memoryAddress + 56, (int)value);
            }
        }
        ...
        public CheckpointCustomIcon CustomIcon
        {
            get
            {
                ...
                return NativeMemory.ReadByte(memoryAddress + 52);
            }
            set
            {
                IntPtr memoryAddress = MemoryAddress;
                ...
                NativeMemory.WriteByte(memoryAddress + 52, value);
                NativeMemory.WriteInt32(memoryAddress + 56, 44); // Sets the icon to a custom icon
            }
        }
        ...
        public float Radius
        {
            get
            {
                ...
                return NativeMemory.ReadFloat(memoryAddress + 60);
            }
            set
            {
                IntPtr memoryAddress = MemoryAddress;
                ...
                NativeMemory.WriteFloat(memoryAddress + 60, value);
            }
        }
        ...
        public Color Color
        {
            get
            {
                ...
                return Color.FromArgb(NativeMemory.ReadInt32(memoryAddress + offset));
            }
            set
            {
                IntPtr memoryAddress = MemoryAddress;
                ...
                var offset = Game.Version >= GameVersion.v1_0_877_1_Steam ? 84 : 80;
                NativeMemory.WriteInt32(memoryAddress + offset, Color.ToArgb());
            }
        }
        ...
        public float CylinderRadius
        {
            get
            {
                ...
                return NativeMemory.ReadFloat(memoryAddress + offset);
            }
            set
            {
                IntPtr memoryAddress = MemoryAddress;
                ...
                var offset = Game.Version >= GameVersion.v1_0_877_1_Steam ? 80 : 76;
                NativeMemory.WriteFloat(memoryAddress + offset, value);
            }
        }
        ...
        {
            Call(Hash.DELETE_CHECKPOINT, Handle);
        }
