...
namespace GTA
{
    public enum VehicleLockStatus
    {
        ...
        [Obsolete(
            "VehicleLockStatus.LockedForPlayer is obsolete, please use VehicleLockStatus.PlayerCannotEnter instead.")]
        LockedForPlayer,
        ...
        /// </summary>
        [Obsolete(
            "VehicleLockStatus.StickPlayerInside is obsolete, please use VehicleLockStatus.PlayerCannotLeaveCanBeBrokenIntoPersist instead.")]
        StickPlayerInside,

        [Obsolete(
            "VehicleLockStatus.CannotBeTriedToEnter is obsolete, please use VehicleLockStatus.IgnoredByPlayer instead.")]
