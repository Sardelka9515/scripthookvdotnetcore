...
namespace GTA
{
    public class EntityBone
    {
        ...
        internal EntityBone(Entity owner, string boneName) : this(owner,
            Call<int>(Hash.GET_ENTITY_BONE_INDEX_BY_NAME, owner.NativeValue, boneName))
        {
        }
        ...
        public Matrix PoseMatrix
        {
            get
            {
                IntPtr address = NativeMemory.GetEntityBonePoseAddress(Owner.Handle, Index);
                if (address == IntPtr.Zero)
                {
                    return Matrix.Zero;
                }

                return new Matrix(NativeMemory.ReadMatrix(address));
            }
            set
            {
                IntPtr address = NativeMemory.GetEntityBonePoseAddress(Owner.Handle, Index);
                ...
                NativeMemory.WriteMatrix(address, value.ToArray());
            }
        }
        ...
        public Matrix RelativeMatrix
        {
            get
            {
                IntPtr address = NativeMemory.GetEntityBoneMatrixAddress(Owner.Handle, Index);
                if (address == IntPtr.Zero)
                {
                    return Matrix.Zero;
                }
        ...
        public Vector3 Pose
        {
            get
            {
                ...
                return new Vector3(NativeMemory.ReadVector3(address + 0x30));
            }
            set
            {
                IntPtr address = NativeMemory.GetEntityBonePoseAddress(Owner.Handle, Index);
                ...
                NativeMemory.WriteVector3(address + 0x30, value.ToArray());
            }
        }
        ...
        /// </summary>
        public Vector3 Position => Call<Vector3>(Hash.GET_WORLD_POSITION_OF_ENTITY_BONE, Owner.Handle, Index);
        ...
        public Vector3 UpVector
        {
            get
            {
                ...
                return Owner.Matrix.TransformPoint(
                    new Matrix(NativeMemory.ReadMatrix(address)).TransformPoint(Vector3.RelativeTop)) - Position;
            }
        }
        ...
        public Vector3 RightVector
        {
            get
            {
                ...
                return Owner.Matrix.TransformPoint(
                    new Matrix(NativeMemory.ReadMatrix(address)).TransformPoint(Vector3.RelativeRight)) - Position;
            }
        }
        ...
        public Vector3 ForwardVector
        {
            get
            {
                ...
                return Owner.Matrix.TransformPoint(
                    new Matrix(NativeMemory.ReadMatrix(address)).TransformPoint(Vector3.RelativeFront)) - Position;
            }
        }
        ...
        public Vector3 RelativeUpVector
        {
            get
            {
                ...
                return new Vector3(NativeMemory.ReadVector3(address + 0x20));
            }
        }
        ...
        public Vector3 RelativeRightVector
        {
            get
            {
                ...
                return new Vector3(NativeMemory.ReadVector3(address));
            }
        }
        ...
        public Vector3 RelativeForwardVector
        {
            get
            {
                ...
                return new Vector3(NativeMemory.ReadVector3(address + 0x10));
            }
        }
        ...
        public int FragmentGroupIndex
        {
            get
            {
                ...
                return NativeMemory.GetFragmentGroupIndexByEntityBoneIndex(address, Index);
            }
        }
        ...
        public Vector3 GetOffsetPosition(Vector3 offset)
        {
            ...
            return Owner.Matrix.TransformPoint(new Matrix(NativeMemory.ReadMatrix(address)).TransformPoint(offset));
        }
        ...
        public Vector3 GetRelativeOffsetPosition(Vector3 offset)
        {
            ...
            return new Matrix(NativeMemory.ReadMatrix(address)).TransformPoint(offset);
        }
        ...
        public Vector3 GetPositionOffset(Vector3 worldCoords)
        {
            ...
            return new Matrix(NativeMemory.ReadMatrix(address)).InverseTransformPoint(
                Owner.Matrix.InverseTransformPoint(worldCoords));
        }
        ...
        public Vector3 GetRelativePositionOffset(Vector3 entityOffset)
        {
            ...
            return new Matrix(NativeMemory.ReadMatrix(address)).InverseTransformPoint(entityOffset);
        }
