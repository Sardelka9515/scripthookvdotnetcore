...
namespace GTA
{
    public class AnimatedBuilding : IExistable
    {
        ...
        /// </returns>
        public static AnimatedBuilding FromHandle(int handle) => NativeMemory.AnimatedBuildingHandleExists(handle)
            ? new AnimatedBuilding(handle)
            : null;
        ...
        /// </summary>
        public IntPtr MemoryAddress => NativeMemory.GetAnimatedBuildingAddress(Handle);
        ...
        public bool Exists()
        {
            return NativeMemory.AnimatedBuildingHandleExists(Handle);
        }
