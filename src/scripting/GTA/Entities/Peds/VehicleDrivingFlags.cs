...
namespace GTA
{
    ...
    public enum VehicleDrivingFlags : uint
    {
        ...
        DrivingModeStopForVehicles = StopForVehicles | StopForPeds | SteerAroundObjects |
                                     SteerAroundStationaryVehicles | StopAtTrafficLights | UseShortCutLinks |
        ...
        DrivingModeAvoidVehicles = SwerveAroundAllVehicles | SteerAroundObjects | UseShortCutLinks |
                                   ChangeLanesAroundObstructions | StopForVehicles,
        ...
        DrivingModeAvoidVehiclesReckless = SwerveAroundAllVehicles | SteerAroundObjects | UseShortCutLinks |
                                           ChangeLanesAroundObstructions,
        ...
        DrivingModeStopForVehiclesIgnoreLights = StopForVehicles | SteerAroundStationaryVehicles | StopForPeds |
                                                 SteerAroundObjects | UseShortCutLinks | ChangeLanesAroundObstructions,

        /// <summary>Try to swerve around everything, but stop for lights if necessary.</summary>
        DrivingModeAvoidVehiclesObeyLights = SwerveAroundAllVehicles | StopAtTrafficLights | SteerAroundObjects |
        ...
        DrivingModeAvoidVehiclesStopForPedsObeyLights = SwerveAroundAllVehicles | StopAtTrafficLights | StopForPeds |
                                                        SteerAroundObjects | UseShortCutLinks |
                                                        ChangeLanesAroundObstructions | StopForVehicles,

        [Obsolete(
            "VehicleDrivingFlags.UseBlinkers is obsolete because it is incorrect, please use VehicleDrivingFlags.GoOffRoadWhenAvoiding instead.")]
        UseBlinkers = 256,

        [Obsolete(
            "VehicleDrivingFlags.FollowTraffic is obsolete because  it has less obvious name, please use VehicleDrivingFlags.StopForVehicles instead.")]
        FollowTraffic = 1,
        ...
        [Obsolete(
            "VehicleDrivingFlags.AvoidVehicles is obsolete because has less obvious name, please use VehicleDrivingFlags.SwerveAroundAllVehicles instead.")]
        AvoidVehicles = 4,

        [Obsolete(
            "VehicleDrivingFlags.AvoidEmptyVehicles is obsolete because it is inaccurate, please use VehicleDrivingFlags.SteerAroundStationaryVehicles instead.")]
        AvoidEmptyVehicles =
            8, // Even with this flag set, the ped may avoid vehicles that have the drivers when it is stationary

        [Obsolete(
            "VehicleDrivingFlags.AvoidPeds is obsolete because it has less obvious name, please use VehicleDrivingFlags.SteerAroundPeds instead.")]
        AvoidPeds = 16,

        [Obsolete(
            "VehicleDrivingFlags.AvoidObjects is obsolete because it has less obvious name, please use VehicleDrivingFlags.SteerAroundObjects instead.")]
        AvoidObjects = 32,

        [Obsolete(
            "VehicleDrivingFlags.AllowMedianCrossing is obsolete because it is inaccurate, please use VehicleDrivingFlags.UseShortCutLinks instead.")]
        AllowMedianCrossing = 262144,

        [Obsolete(
            "VehicleDrivingFlags.IgnorePathFinding is obsolete because it has less obvious name, please use VehicleDrivingFlags.ForceStraightLine instead.")]
        IgnorePathFinding = 16777216,

        [Obsolete(
            "VehicleDrivingFlags.DriveBySight is obsolete because it is inaccurate, please use VehicleDrivingFlags.PreferNavmeshRoute instead.")]
