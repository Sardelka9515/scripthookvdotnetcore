...
namespace GTA
{
    public class Building : IExistable
    {
        ...
        public static Building FromHandle(int handle) =>
            NativeMemory.BuildingHandleExists(handle) ? new Building(handle) : null;
        ...
        /// </summary>
        public IntPtr MemoryAddress => NativeMemory.GetBuildingAddress(Handle);
        ...
        public bool Exists()
        {
            return NativeMemory.BuildingHandleExists(Handle);
        }
