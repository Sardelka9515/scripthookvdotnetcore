...
namespace GTA
{
    public abstract class Entity : PoolObject, ISpatial
    {
        ...
        public static Entity FromHandle(int handle)
        {
            ...
            var entityType = (EntityTypeInternal)NativeMemory.ReadByte(memoryAddress + 0x28);
        ...
        /// </summary>
        public IntPtr MemoryAddress => NativeMemory.GetEntityAddress(Handle);
        ...
        public EntityType EntityType
        {
            get
            {
                ...
                // Read the same field as GET_ENTITY_TYPE does
                var entityType = (EntityTypeInternal)NativeMemory.ReadByte(address + 0x28);
        ...
        {
            get => (EntityPopulationType)Call<int>(Hash.GET_ENTITY_POPULATION_TYPE, Handle);
            set
            {
                var address = MemoryAddress;
                if (address == IntPtr.Zero)
                ...
                NativeMemory.WriteByte(address + 0xDA, (byte)((int)value & 0xF));
            }
        }
        ...
        public bool IsDead => Call<bool>(Hash.IS_ENTITY_DEAD, Handle);
        ...
        /// </summary>
        public Model Model => new(Call<int>(Hash.GET_ENTITY_MODEL, Handle));
        ...
        public int Opacity
        {
            get => Call<int>(Hash.GET_ENTITY_ALPHA, Handle);
            set => Call(Hash.SET_ENTITY_ALPHA, Handle, value, false);
        }
        ...
        {
            Call(Hash.RESET_ENTITY_ALPHA, Handle);
        }
        ...
        {
            get => Call<int>(Hash.GET_ENTITY_LOD_DIST, Handle);
            set => Call(Hash.SET_ENTITY_LOD_DIST, Handle, value);
        }
        ...
        {
            get => Call<bool>(Hash.IS_ENTITY_A_MISSION_ENTITY, Handle);
            set
            {
                if (value)
                {
                    Call(Hash.SET_ENTITY_AS_MISSION_ENTITY, Handle, true, true);
                }
                else
                {
        ...
        public bool IsPositionFrozen
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 0x2E, 1);
            }
            set => Call(Hash.FREEZE_ENTITY_POSITION, Handle, value);
        }
        ...
        public int Health
        {
            get => Call<int>(Hash.GET_ENTITY_HEALTH, Handle);
            set => Call(Hash.SET_ENTITY_HEALTH, Handle, value);
        }
        ...
        {
            get => Call<int>(Hash.GET_ENTITY_MAX_HEALTH, Handle);
            set => Call(Hash.SET_ENTITY_MAX_HEALTH, Handle, value);
        }
        ...
        public float HealthFloat
        {
            get
            {
                ...
                return NativeMemory.ReadFloat(address + 640);
            }
            set
            {
                var address = MemoryAddress;
                ...
                NativeMemory.WriteFloat(address + 640, value);
            }
        }
        ...
        public float MaxHealthFloat
        {
            ...
            {
                var address = MemoryAddress;
                if (address == IntPtr.Zero || NativeMemory.EntityMaxHealthOffset == 0)
                {
                    return 0.0f;
                }

                return NativeMemory.ReadFloat(address + NativeMemory.EntityMaxHealthOffset);
            }
            set
            {
                var address = MemoryAddress;
                ...
                NativeMemory.WriteFloat(address + NativeMemory.EntityMaxHealthOffset, value);
            }
        }
        ...
        public Matrix Matrix
        {
            get
            {
                ...
                return new Matrix(NativeMemory.ReadMatrix(address + 96));
            }
        }
        ...
        {
            get => Call<Vector3>(Hash.GET_ENTITY_COORDS, Handle, 0);
            set => Call(Hash.SET_ENTITY_COORDS, Handle, value.X, value.Y, value.Z, 0, 0, 0, 1);
        }
        ...
        {
            set => Call(Hash.SET_ENTITY_COORDS_NO_OFFSET, Handle, value.X, value.Y, value.Z, 1, 1, 1);
        }
        ...
        {
            get => Call<Vector3>(Hash.GET_ENTITY_ROTATION, Handle, 2);
            set => Call(Hash.SET_ENTITY_ROTATION, Handle, value.X, value.Y, value.Z, 2, 1);
        }
        ...
        {
            get => Call<float>(Hash.GET_ENTITY_HEADING, Handle);
            set => Call<float>(Hash.SET_ENTITY_HEADING, Handle, value);
        }

        /// <summary>
        /// Gets a value indicating how submersed this <see cref="Entity"/> is, 1.0f means the whole entity is submerged.
        /// </summary>
        public float SubmersionLevel => Call<float>(Hash.GET_ENTITY_SUBMERGED_LEVEL, Handle);

        /// <summary>
        /// Gets how high above ground this <see cref="Entity"/> is.
        /// </summary>
        public float HeightAboveGround => Call<float>(Hash.GET_ENTITY_HEIGHT_ABOVE_GROUND, Handle);
        ...
        public Quaternion Quaternion
        {
            get
            {
                ...
                unsafe
                {
                    Call(Hash.GET_ENTITY_QUATERNION, Handle, &x, &y, &z, &w);
                }

                return new Quaternion(x, y, z, w);
            }
            set => Call(Hash.SET_ENTITY_QUATERNION, Handle, value.X, value.Y, value.Z, value.W);
        }
        ...
        public Vector3 UpVector
        {
            get
            {
                ...
                return new Vector3(NativeMemory.ReadVector3(address + 0x80));
            }
        }
        ...
        public Vector3 RightVector
        {
            get
            {
                ...
                return new Vector3(NativeMemory.ReadVector3(address + 0x60));
            }
        }
        ...
        public Vector3 ForwardVector
        {
            get
            {
                ...
                return new Vector3(NativeMemory.ReadVector3(address + 0x70));
            }
        }
        ...
        {
            return Call<Vector3>(Hash.GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS, Handle, offset.X, offset.Y, offset.Z);
        }
        ...
        {
            return Call<Vector3>(Hash.GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS, Handle, worldCoords.X, worldCoords.Y,
                worldCoords.Z);
        }
        ...
        {
            set => Call(Hash.SET_ENTITY_MAX_SPEED, Handle, value);
        }
        ...
        {
            get => Call<Vector3>(Hash.GET_ENTITY_VELOCITY, Handle);
            set => Call(Hash.SET_ENTITY_VELOCITY, Handle, value.X, value.Y, value.Z);
        }
        ...
        {
            get => Call<Vector3>(Hash.GET_ENTITY_ROTATION_VELOCITY, Handle);
            set
            {
                var address = MemoryAddress;
                if (address == IntPtr.Zero)
                ...
                NativeMemory.SetEntityAngularVelocity(address, angularVelocityInLocalAxes.X,
                    angularVelocityInLocalAxes.Y, angularVelocityInLocalAxes.Z);
            }
        }
        ...
        public Vector3 WorldRotationVelocity
        {
            get
            {
                ...
                unsafe
                {
                    var returnVectorPtr = NativeMemory.GetEntityAngularVelocity(address);
            ...
            set
            {
                ...
                NativeMemory.SetEntityAngularVelocity(address, value.X, value.Y, value.Z);
            }
        }
        ...
        /// </summary>
        public EntityDamageRecordCollection DamageRecords =>
            _damageRecords ?? (_damageRecords = new EntityDamageRecordCollection(this));
        ...
        {
            return Call<bool>(Hash.HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY, Handle, entity.Handle, 1);
        }
        ...
        {
            return Call<bool>(Hash.HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON, Handle, weapon, 0);
        }
        ...
        {
            return Call<bool>(Hash.HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON, Handle, 0, 2);
        }
        ...
        {
            return Call<bool>(Hash.HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON, Handle, 0, 1);
        }
        ...
        {
            Call(Hash.CLEAR_ENTITY_LAST_WEAPON_DAMAGE, Handle);
        }
        ...
        public int FragmentGroupCount
        {
            get
            {
                ...
                return NativeMemory.GetFragmentGroupCountFromEntity(address);
            }
        }
        ...
        public bool IsFragmentObject
        {
            get
            {
                ...
                return NativeMemory.IsEntityFragmentObject(address);
            }
        }
        ...
        public bool DetachFragmentPart(int fragmentGroupIndex)
        {
            ...
            return NativeMemory.DetachFragmentPartByIndex(address, fragmentGroupIndex);
        }
        ...
        public bool IsFireProof
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 392, 5);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (value)
                {
                    NativeMemory.SetBit(address + 392, 5);
                }
                else
                {
                    NativeMemory.ClearBit(address + 392, 5);
                }
            }
        }
        ...
        public bool IsMeleeProof
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 392, 7);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (value)
                {
                    NativeMemory.SetBit(address + 392, 7);
                }
                else
                {
                    NativeMemory.ClearBit(address + 392, 7);
                }
            }
        }
        ...
        public bool IsBulletProof
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 392, 4);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (value)
                {
                    NativeMemory.SetBit(address + 392, 4);
                }
                else
                {
                    NativeMemory.ClearBit(address + 392, 4);
                }
            }
        }
        ...
        public bool IsExplosionProof
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 392, 11);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (value)
                {
                    NativeMemory.SetBit(address + 392, 11);
                }
                else
                {
                    NativeMemory.ClearBit(address + 392, 11);
                }
            }
        }
        ...
        public bool IsCollisionProof
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 392, 6);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (value)
                {
                    NativeMemory.SetBit(address + 392, 6);
                }
                else
                {
                    NativeMemory.ClearBit(address + 392, 6);
                }
            }
        }
        ...
        public bool IsWaterCannonProof
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 392, 12);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (value)
                {
                    NativeMemory.SetBit(address + 392, 12);
                }
                else
                {
                    NativeMemory.ClearBit(address + 392, 12);
                }
            }
        }
        ...
        public bool IsSteamProof
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 392, 15);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (value)
                {
                    NativeMemory.SetBit(address + 392, 15);
                }
                else
                {
                    NativeMemory.ClearBit(address + 392, 15);
                }
            }
        }
        ...
        public bool IsSmokeProof
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 392, 16);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (value)
                {
                    NativeMemory.SetBit(address + 392, 16);
                }
                else
                {
                    NativeMemory.ClearBit(address + 392, 16);
                }
            }
        }
        ...
        public bool IsInvincible
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 392, 8);
            }
            set => Call(Hash.SET_ENTITY_INVINCIBLE, Handle, value);
        }
        ...
        public bool IsOnlyDamagedByPlayer
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 392, 10);
            }
            set => Call(Hash.SET_ENTITY_ONLY_DAMAGED_BY_PLAYER, Handle, value);
        }
        ...
        {
            get => Call<bool>(Hash.IS_ENTITY_VISIBLE, Handle);
            set => Call(Hash.SET_ENTITY_VISIBLE, Handle, value);
        }
        ...
        {
            get => Call<bool>(Hash.IS_ENTITY_OCCLUDED, Handle);
        }
        ...
        public bool IsRendered
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 176, 4);
            }
        }
        ...
        /// </value>
        public bool IsOnFire => Call<bool>(Hash.IS_ENTITY_ON_FIRE, Handle);
        ...
        /// </value>
        public bool IsOnScreen => Call<bool>(Hash.IS_ENTITY_ON_SCREEN, Handle);
        ...
        /// </value>
        public bool IsUpright => Call<bool>(Hash.IS_ENTITY_UPRIGHT, Handle, 30.0f);
        ...
        /// </value>
        public bool IsUpsideDown => Call<bool>(Hash.IS_ENTITY_UPSIDEDOWN, Handle);
        ...
        /// </value>
        public bool IsInAir => Call<bool>(Hash.IS_ENTITY_IN_AIR, Handle);
        ...
        /// </value>
        public bool IsInWater => Call<bool>(Hash.IS_ENTITY_IN_WATER, Handle);
        ...
        public bool HasGravity
        {
            get
            {
                ...
                address = NativeMemory.ReadAddress(address + 48);
                if (address == IntPtr.Zero)
                {
                    return true;
                }

                return !NativeMemory.IsBitSet(address + 26, 4);
            }
            set => Call(Hash.SET_ENTITY_HAS_GRAVITY, Handle, value);
        }
        ...
        {
            Call(Hash.REMOVE_PARTICLE_FX_FROM_ENTITY, Handle);
        }
        ...
        public bool HasCollided => Call<bool>(Hash.HAS_ENTITY_COLLIDED_WITH_ANYTHING, Handle);
        ...
        public MaterialHash MaterialCollidingWith =>
            (MaterialHash)Call<uint>(Hash.GET_LAST_MATERIAL_HIT_BY_ENTITY, Handle);
        ...
        {
            get => !Call<bool>(Hash.GET_ENTITY_COLLISION_DISABLED, Handle);
            set => Call(Hash.SET_ENTITY_COLLISION, Handle, value, false);
        }
        ...
        {
            set => Call(Hash.SET_ENTITY_RECORDS_COLLISIONS, Handle, value);
        }
        ...
        {
            Call(Hash.SET_ENTITY_NO_COLLISION_ENTITY, Handle, entity.Handle, toggle);
        }
        ...
        {
            return Call<bool>(Hash.IS_ENTITY_IN_AREA, Handle, minBounds.X, minBounds.Y, minBounds.Z, maxBounds.X,
        ...
        public bool IsInAngledArea(Vector3 origin, Vector3 edge, float angle) =>
            IsInAngledArea(origin, edge, angle, true);
        ...
        {
            return Call<bool>(Hash.IS_ENTITY_IN_ANGLED_AREA, Handle, originEdge.X, originEdge.Y, originEdge.Z,
                extentEdge.X, extentEdge.Y, extentEdge.Z, width, false, includeZAxis, 0);
        }
        ...
        {
            return Call<bool>(Hash.IS_ENTITY_AT_ENTITY, Handle, entity.Handle, bounds.X, bounds.Y, bounds.Z, false,
                true, false);
        }
        ...
        {
            return Call<bool>(Hash.IS_ENTITY_TOUCHING_MODEL, Handle, model.Hash);
        }
        ...
        {
            return Call<bool>(Hash.IS_ENTITY_TOUCHING_ENTITY, Handle, entity.Handle);
        }
        ...
        public Blip AddBlip()
        {
            return new Blip(Call<int>(Hash.ADD_BLIP_FOR_ENTITY, Handle));
        }
        ...
        public Blip AttachedBlip
        {
            get
            {
                int handle = Call<int>(Hash.GET_BLIP_FROM_ENTITY, Handle);

                if (Call<bool>(Hash.DOES_BLIP_EXIST, handle))
                {
        ...
        {
            get => World.GetAllBlips()
                .Where(x => Call<int>(Hash.GET_BLIP_INFO_ID_ENTITY_INDEX, x.NativeValue) == Handle).ToArray();
        }
        ...
        public void Detach()
        {
            Call(Hash.DETACH_ENTITY, Handle, true, true);
        }
        ...
        {
            Call(Hash.ATTACH_ENTITY_TO_ENTITY, Handle, entity.Handle, -1, position.X, position.Y, position.Z,
                rotation.X, rotation.Y, rotation.Z, 0, 0, 0, 0, 2, 1);
        }
        ...
        {
            Call(Hash.ATTACH_ENTITY_TO_ENTITY, Handle, entityBone.Owner.Handle, entityBone, position.X, position.Y,
        ...
        {
            return Call<bool>(Hash.IS_ENTITY_ATTACHED, Handle);
        }
        ...
        {
            return Call<bool>(Hash.IS_ENTITY_ATTACHED_TO_ENTITY, Handle, entity.Handle);
        }
        ...
        {
            get => FromHandle(Call<int>(Hash.GET_ENTITY_ATTACHED_TO, Handle));
        }
        ...
        public void ApplyForce(Vector3 direction, Vector3 rotation = default,
            ForceType forceType = ForceType.MaxForceRot2)
        {
            Call(Hash.APPLY_FORCE_TO_ENTITY, Handle, forceType, direction.X, direction.Y, direction.Z, rotation.X,
                rotation.Y, rotation.Z, false, false, true, true, false, true);
        }
        ...
        /// <param name="rotation">The offset from the root bone of this <see cref="Entity"/> where the force applies. "rotation" is incorrectly named parameter but is left for scripts that use the method with named parameters.</param>
        /// <param name="forceType">Type of the force to apply.</param>
        public void ApplyForceRelative(Vector3 direction, Vector3 rotation = default,
            ForceType forceType = ForceType.MaxForceRot2)
        {
            Call(Hash.APPLY_FORCE_TO_ENTITY, Handle, forceType, direction.X, direction.Y, direction.Z, rotation.X,
                rotation.Y, rotation.Z, false, true, true, true, false, true);
        }
        ...
        public void MarkAsNoLongerNeeded()
        {
            ...
            unsafe
            {
                Call(Hash.SET_ENTITY_AS_NO_LONGER_NEEDED, &handle);
            }
        ...
        {
            int handle = Handle;
            Call(Hash.SET_ENTITY_AS_MISSION_ENTITY, handle, false, true);
            unsafe
            {
                Call(Hash.DELETE_ENTITY, &handle);
            }
        ...
        {
            return Call<bool>(Hash.DOES_ENTITY_EXIST, Handle);
        }
