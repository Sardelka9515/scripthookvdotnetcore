...
namespace GTA
{
    public struct WeaponAsset : IEquatable<WeaponAsset>, INativeValue
    {
        ...
        /// </summary>
        public bool IsValid => Call<bool>(Native.Hash.IS_WEAPON_VALID, Hash);

        /// <summary>
        /// Gets a value indicating whether this <see cref="WeaponAsset"/> is valid as a weapon hash.
        /// </summary>
        public bool IsValidAsWeaponHash => NativeMemory.IsHashValidAsWeaponHash((uint)Hash);

        /// <summary>
        /// Gets a value indicating whether this <see cref="WeaponAsset"/> is loaded so it can be spawned.
        /// </summary>
        public bool IsLoaded => Call<bool>(Native.Hash.HAS_WEAPON_ASSET_LOADED, Hash);
        ...
        public void Request()
        {
            Call(Native.Hash.REQUEST_WEAPON_ASSET, Hash, 31, 0);
        }
        ...
        {
            Call(Native.Hash.REMOVE_WEAPON_ASSET, Hash);
        }

        public string DisplayName =>
            IsValidAsWeaponHash ? Weapon.GetDisplayNameFromHash((WeaponHash)Hash) : string.Empty;

        public string LocalizedName => IsValidAsWeaponHash
            ? Game.GetLocalizedString(Weapon.GetDisplayNameFromHash((WeaponHash)Hash))
            : string.Empty;
