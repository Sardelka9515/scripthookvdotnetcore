...
namespace GTA
{
    public sealed class ParticleEffect : PoolObject
    {
        ...
        /// </summary>
        public IntPtr MemoryAddress => NativeMemory.GetPtfxAddress(Handle);
        ...
        public Vector3 Offset
        {
            get
            {
                ...
                address = NativeMemory.ReadAddress(address + 32);
                if (address == IntPtr.Zero)
                {
                    return Vector3.Zero;
                }

                return new Vector3(NativeMemory.ReadVector3(address + 144));
            }
            set
            {
                IntPtr address = MemoryAddress;
                ...
                NativeMemory.WriteVector3(address + 144, value.ToArray());
            }
        }
        ...
        public Vector3 Rotation
        {
            set
            {
                ...
                Call(Hash.SET_PARTICLE_FX_LOOPED_OFFSETS, Handle, currentOffset.X, currentOffset.Y, currentOffset.Z,
        ...
        public Color Color
        {
            get
            {
                ...
                address = NativeMemory.ReadAddress(address + 32) + 320;
                byte r = Convert.ToByte(NativeMemory.ReadFloat(address) * 255f);
                byte g = Convert.ToByte(NativeMemory.ReadFloat(address + 4) * 255f);
                byte b = Convert.ToByte(NativeMemory.ReadFloat(address + 8) * 255f);
                byte a = Convert.ToByte(NativeMemory.ReadFloat(address + 12) * 255f);
            ...
            set
            {
                ...
                address = NativeMemory.ReadAddress(address + 32) + 320;
                NativeMemory.WriteFloat(address, value.R / 255f);
                NativeMemory.WriteFloat(address + 4, value.G / 255f);
                NativeMemory.WriteFloat(address + 8, value.B / 255f);
                NativeMemory.WriteFloat(address + 12, value.A / 255f);
            }
        }
        ...
        public float Scale
        {
            get
            {
                ...
                return NativeMemory.ReadFloat(NativeMemory.ReadAddress(address + 32) + 336);
            }
            set
            {
                IntPtr address = MemoryAddress;
                ...
                NativeMemory.WriteFloat(NativeMemory.ReadAddress(address + 32) + 336, value);
            }
        }
        ...
        public float Range
        {
            get
            {
                ...
                return NativeMemory.ReadFloat(NativeMemory.ReadAddress(address + 32) + 384);
            }
            set => Call(Hash.SET_PARTICLE_FX_LOOPED_FAR_CLIP_DIST, Handle, value);
        }
        ...
        {
            Call(Hash.SET_PARTICLE_FX_LOOPED_EVOLUTION, parameterName, value, 0);
        }
        ...
        {
            Call(Hash.REMOVE_PARTICLE_FX, Handle, false);
        }
        ...
        {
            return Call<bool>(Hash.DOES_PARTICLE_FX_LOOPED_EXIST, Handle);
        }
