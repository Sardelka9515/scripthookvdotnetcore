...
namespace GTA
{
    public static class World
    {
        ...
        {
            get => NativeMemory.IsClockPaused;
            set => Call(Hash.PAUSE_CLOCK, value);
        }
        ...
        public static DateTime CurrentDate
        {
            get
            {
                int year = Call<int>(Hash.GET_CLOCK_YEAR);
                int month = Call<int>(Hash.GET_CLOCK_MONTH) + 1;
                int day = System.Math.Min(Call<int>(Hash.GET_CLOCK_DAY_OF_MONTH), calendar.GetDaysInMonth(year, month));
                int hour = Call<int>(Hash.GET_CLOCK_HOURS);
                int minute = Call<int>(Hash.GET_CLOCK_MINUTES);
                int second = Call<int>(Hash.GET_CLOCK_SECONDS);

                return new DateTime(year, month, day, hour, minute, second);
            }
            set
            {
                Call(Hash.SET_CLOCK_DATE, value.Day, value.Month - 1, value.Year);
                Call(Hash.SET_CLOCK_TIME, value.Hour, value.Minute, value.Second);
            }
        }
        ...
        public static TimeSpan CurrentTimeOfDay
        {
            get
            {
                int hours = Call<int>(Hash.GET_CLOCK_HOURS);
                int minutes = Call<int>(Hash.GET_CLOCK_MINUTES);
                int seconds = Call<int>(Hash.GET_CLOCK_SECONDS);

                return new TimeSpan(hours, minutes, seconds);
            }
            set => Call(Hash.SET_CLOCK_TIME, value.Hours, value.Minutes, value.Seconds);
        }
        ...
        {
            get => Call<int>(Hash.GET_MILLISECONDS_PER_GAME_MINUTE);
            set => NativeMemory.MillisecondsPerGameMinute = value;
        }
        ...
        {
            set => Call(Hash.SET_ARTIFICIAL_LIGHTS_STATE, value);
        }
        ...
        public static Weather Weather
        {
            get
            {
                ...
                {
                    if (Call<int>(Hash.GET_PREV_WEATHER_TYPE_HASH_NAME) == Game.GenerateHash(weatherNames[i]))
                    {
                        return (Weather)i;
                    }
                }
            ...
            set
            {
                ...
                {
                    Call(Hash.SET_WEATHER_TYPE_NOW, weatherNames[(int)value]);
                }
            }
        }
        ...
        public static Weather NextWeather
        {
            get
            {
                for (int i = 0; i < weatherNames.Length; i++)
                {
                    if (Call<bool>(Hash.IS_NEXT_WEATHER_TYPE, weatherNames[i]))
                    {
                        return (Weather)i;
                    }
                }
            ...
            set
            {
                if (Enum.IsDefined(typeof(Weather), value) && value != Weather.Unknown)
                {
                    ...
                    unsafe
                    {
                        Call(Hash.GET_CURR_WEATHER_STATE, &currentWeatherHash, &nextWeatherHash, &weatherTransition);
                    }

                    Call(Hash.SET_CURR_WEATHER_STATE, currentWeatherHash, Game.GenerateHash(weatherNames[(int)value]),
                        0.0f);
                }
            }
        }
        ...
        public static void TransitionToWeather(Weather weather, float duration)
        {
            ...
            {
                Call(Hash.SET_WEATHER_TYPE_OVERTIME_PERSIST, weatherNames[(int)weather], duration);
            }
        }
        ...
        public static Blip WaypointBlip
        {
            get
            {
                var handle = NativeMemory.GetWaypointBlip();
        ...
        public static Vector3 WaypointPosition
        {
            ...
            set { Call(Hash.SET_NEW_WAYPOINT, value.X, value.Y); }
        }
        ...
        public static Blip[] GetAllBlips(params BlipSprite[] blipTypes)
        {
            ...
            return Array.ConvertAll(NativeMemory.GetNonCriticalRadarBlipHandles(blipTypesInt),
                handle => new Blip(handle));
        }
        ...
        public static Blip[] GetNearbyBlips(Vector3 position, float radius, params BlipSprite[] blipTypes)
        {
            ...
            return Array.ConvertAll(
                NativeMemory.GetNonCriticalRadarBlipHandles(position.ToArray(), radius, blipTypesInt),
                handle => new Blip(handle));
        }
        ...
        {
            return new Blip(Call<int>(Hash.ADD_BLIP_FOR_COORD, position.X, position.Y, position.Z));
        }
        ...
        {
            return new Blip(Call<int>(Hash.ADD_BLIP_FOR_RADIUS, position.X, position.Y, position.Z, radius));
        }
        ...
        public static int VehicleCapacity => NativeMemory.GetVehicleCapacity();
        ...
        public static int PedCapacity => NativeMemory.GetPedCapacity();
        ...
        public static int PropCapacity => NativeMemory.GetObjectCapacity();

        /// <summary>
        /// The total number of <see cref="Prop"/>s in the world associated with a <see cref="Pickup"/> that can exist in the world.
        /// </summary>
        public static int PickupObjectCapacity => NativeMemory.GetPickupObjectCapacity();
        ...
        /// </summary>
        public static int ProjectileCapacity => NativeMemory.GetProjectileCapacity();

        /// <summary>
        /// The total number of <see cref="Building"/>s that can exist in the world.
        /// </summary>
        public static int BuildingCapacity => NativeMemory.GetBuildingCapacity();

        /// <summary>
        /// The total number of <see cref="AnimatedBuilding"/>s that can exist in the world.
        /// </summary>
        public static int AnimatedBuildingCapacity => NativeMemory.GetAnimatedBuildingCapacity();

        /// <summary>
        /// The total number of <see cref="InteriorInstance"/>s that can exist in the world.
        /// </summary>
        public static int InteriorInstanceCapacity => NativeMemory.GetInteriorInstCapacity();

        /// <summary>
        /// The total number of <see cref="InteriorProxy"/>s the game can manage at the same time in the <see cref="InteriorProxy"/> pool.
        /// </summary>
        public static int InteriorProxyCapacity => NativeMemory.GetInteriorProxyCapacity();
        ...
        /// </summary>
        public static int EntityColliderCapacity => NativeMemory.GetEntityColliderCapacity();
        ...
        public static Ped[] GetAllPeds(params Model[] models)
        {
            ...
            return Array.ConvertAll(NativeMemory.GetPedHandles(hashes), handle => new Ped(handle));
        }
        ...
        {
            int[] hashes = Array.ConvertAll(models, model => model.Hash);
            int[] handles = NativeMemory.GetPedHandles(ped.Position.ToArray(), radius, hashes);
        ...
        {
            int[] hashes = Array.ConvertAll(models, model => model.Hash);
            return Array.ConvertAll(NativeMemory.GetPedHandles(position.ToArray(), radius, hashes),
        ...
        {
            int[] hashes = Array.ConvertAll(models, model => model.Hash);
            return Array.ConvertAll(NativeMemory.GetVehicleHandles(hashes), handle => new Vehicle(handle));
        }
        ...
        {
            int[] hashes = Array.ConvertAll(models, model => model.Hash);
            int[] handles = NativeMemory.GetVehicleHandles(ped.Position.ToArray(), radius, hashes);
        ...
        {
            int[] hashes = Array.ConvertAll(models, model => model.Hash);
            return Array.ConvertAll(NativeMemory.GetVehicleHandles(position.ToArray(), radius, hashes),
        ...
        {
            int[] hashes = Array.ConvertAll(models, model => model.Hash);
            return Array.ConvertAll(NativeMemory.GetPropHandles(hashes), handle => new Prop(handle));
        }
        ...
        {
            int[] hashes = Array.ConvertAll(models, model => model.Hash);
            return Array.ConvertAll(NativeMemory.GetPropHandles(position.ToArray(), radius, hashes),
        ...
        {
            return Array.ConvertAll(NativeMemory.GetPickupObjectHandles(), handle => new Prop(handle));
        }
        ...
        {
            return Array.ConvertAll(NativeMemory.GetPickupObjectHandles(position.ToArray(), radius),
                handle => new Prop(handle));
        }
        ...
        {
            return Array.ConvertAll(NativeMemory.GetProjectileHandles(), handle => new Projectile(handle));
        }
        ...
        {
            return Array.ConvertAll(NativeMemory.GetProjectileHandles(position.ToArray(), radius),
                handle => new Projectile(handle));
        }
        ...
        {
            return Array.ConvertAll(NativeMemory.GetEntityHandles(), Entity.FromHandle);
        }
        ...
        {
            return Array.ConvertAll(NativeMemory.GetEntityHandles(position.ToArray(), radius), Entity.FromHandle);
        }

        public static Building[] GetAllBuildings()
        {
            return Array.ConvertAll(NativeMemory.GetBuildingHandles(), Building.FromHandle);
        }

        public static Building[] GetNearbyBuildings(Vector3 position, float radius)
        {
            return Array.ConvertAll(NativeMemory.GetBuildingHandles(position.ToArray(), radius), Building.FromHandle);
        }
        ...
        {
            return Array.ConvertAll(NativeMemory.GetAnimatedBuildingHandles(), AnimatedBuilding.FromHandle);
        }

        public static AnimatedBuilding[] GetNearbyAnimatedBuildings(Vector3 position, float radius)
        {
            return Array.ConvertAll(NativeMemory.GetAnimatedBuildingHandles(position.ToArray(), radius),
                AnimatedBuilding.FromHandle);
        }
        ...
        {
            return Array.ConvertAll(NativeMemory.GetInteriorInstHandles(), InteriorInstance.FromHandle);
        }

        public static InteriorInstance[] GetNearbyInteriorInstances(Vector3 position, float radius)
        {
            return Array.ConvertAll(NativeMemory.GetInteriorInstHandles(position.ToArray(), radius),
                InteriorInstance.FromHandle);
        }
        ...
        {
            return Array.ConvertAll(NativeMemory.GetInteriorProxyHandles(), InteriorProxy.FromHandle);
        }

        public static InteriorProxy[] GetNearbyInteriorProxies(Vector3 position, float radius)
        {
            return Array.ConvertAll(NativeMemory.GetInteriorProxyHandles(position.ToArray(), radius),
                InteriorProxy.FromHandle);
        }
        ...
        public static Ped CreatePed(Model model, Vector3 position, float heading = 0f)
        {
            ...
            return new Ped(Call<int>(Hash.CREATE_PED, 26, model.Hash, position.X, position.Y, position.Z, heading,
                false, false));
        }
        ...
        public static Ped CreateRandomPed(Vector3 position)
        {
            ...
            return new Ped(Call<int>(Hash.CREATE_RANDOM_PED, position.X, position.Y, position.Z));
        }
        ...
        public static Ped CreateRandomPed(Vector3 position, float heading, Func<Model, bool> predicate = null)
        {
            ...
            var loadedAppropriatePedModels = NativeMemory.GetLoadedAppropriatePedHashes().Select(x => new Model(x));
            ...
            var createdPed = new Ped(Call<int>(Hash.CREATE_PED, 26, pickedModel, position.X, position.Y, position.Z,
                heading, false, false));

            // Randomize clothes and ped props just like CREATE_RANDOM_PED does
            Call(Hash.SET_PED_RANDOM_COMPONENT_VARIATION, createdPed.Handle, 0);
            Call(Hash.SET_PED_RANDOM_PROPS, createdPed.Handle);
        ...
        public static Vehicle CreateVehicle(Model model, Vector3 position, float heading = 0f)
        {
            ...
            return new Vehicle(Call<int>(Hash.CREATE_VEHICLE, model.Hash, position.X, position.Y, position.Z, heading,
                false, false));
        }
        ...
        public static Vehicle CreateRandomVehicle(Vector3 position, float heading = 0f,
            Func<Model, bool> predicate = null)
        {
            ...
            var loadedAppropriateVehModels = NativeMemory.GetLoadedAppropriateVehicleHashes().Select(x => new Model(x));
            var filteredVehModels = predicate != null
                ? loadedAppropriateVehModels.Where(predicate).ToArray()
                : loadedAppropriateVehModels.ToArray();
            ...
            return new Vehicle(Call<int>(Hash.CREATE_VEHICLE, pickedModel, position.X, position.Y, position.Z, heading,
                false, false));
        }
        ...
        public static Prop CreateProp(Model model, Vector3 position, bool dynamic, bool placeOnGround)
        {
            ...
            return new Prop(
                Call<int>(Hash.CREATE_OBJECT, model.Hash, position.X, position.Y, position.Z, 1, 1, dynamic));
        }
        ...
        public static Prop CreatePropNoOffset(Model model, Vector3 position, bool dynamic)
        {
            ...
            return new Prop(Call<int>(Hash.CREATE_OBJECT_NO_OFFSET, model.Hash, position.X, position.Y, position.Z, 1,
                1, dynamic));
        }
        ...
        public static Prop CreateAmbientPickup(PickupType type, Vector3 position, Model model, int value)
        {
            ...
            int handle = Call<int>(Hash.CREATE_AMBIENT_PICKUP, type, position.X, position.Y, position.Z, 0, value,
                model.Hash, false, true);
        ...
        public static Pickup CreatePickup(PickupType type, Vector3 position, Model model, int value)
        {
            ...
            int handle = Call<int>(Hash.CREATE_PICKUP, type, position.X, position.Y, position.Z, 0, value, true,
                model.Hash);
        ...
        public static Pickup CreatePickup(PickupType type, Vector3 position, Vector3 rotation, Model model, int value)
        {
            ...
            int handle = Call<int>(Hash.CREATE_PICKUP_ROTATE, type, position.X, position.Y, position.Z, rotation.X,
                rotation.Y, rotation.Z, 0, value, 2, true, model.Hash);
        ...
        {
            return Array.ConvertAll(NativeMemory.GetCheckpointHandles(), element => new Checkpoint(element));
        }
        ...
        public static Checkpoint CreateCheckpoint(CheckpointIcon icon, Vector3 position, Vector3 pointTo, float radius,
            Color color)
        {
            int handle = Call<int>(Hash.CREATE_CHECKPOINT, icon, position.X, position.Y, position.Z, pointTo.X,
                pointTo.Y, pointTo.Z, radius, color.R, color.G, color.B, color.A, 0);
        ...
        /// <param name="color">The color of the <see cref="Checkpoint"/>.</param>
        /// <remarks>returns <see langword="null" /> if the <see cref="Checkpoint"/> could not be created</remarks>
        public static Checkpoint CreateCheckpoint(CheckpointCustomIcon icon, Vector3 position, Vector3 pointTo,
            float radius, Color color)
        {
            int handle = Call<int>(Hash.CREATE_CHECKPOINT, 44, position.X, position.Y, position.Z, pointTo.X, pointTo.Y,
                pointTo.Z, radius, color.R, color.G, color.B, color.A, icon);
            return handle != 0 ? new Checkpoint(handle) : null;
        }
        ...
        {
            return new Camera(Call<int>(Hash.CREATE_CAM_WITH_PARAMS, "DEFAULT_SCRIPTED_CAMERA", position.X, position.Y,
                position.Z, rotation.X, rotation.Y, rotation.Z, fov, 1, 2));
        }
        ...
        {
            get { return new Camera(Call<int>(Hash.GET_RENDERING_CAM)); }
            set
            {
                if (value == null)
                {
                    Call(Hash.RENDER_SCRIPT_CAMS, false, 0, 3000, 1, 0);
                }
                else
                {
                    value.IsActive = true;
                    Call(Hash.RENDER_SCRIPT_CAMS, true, 0, 3000, 1, 0);
                }
            }
        }
        ...
        public static bool CreateParticleEffectNonLooped(ParticleEffectAsset asset, string effectName, Vector3 pos,
            Vector3 rot = default, float scale = 1.0f, InvertAxisFlags invertAxis = InvertAxisFlags.None)
        {
            if (!asset.UseNext())
            {
                return false;
            ...
            return Call<bool>(Hash.START_PARTICLE_FX_NON_LOOPED_AT_COORD, effectName, pos.X, pos.Y, pos.Z, rot.X, rot.Y,
                rot.Z, scale, invertAxisFlagX, invertAxisFlagY, invertAxisFlagZ);
        }
        ...
        /// <returns><see langword="true" />If the effect was able to start; otherwise, <see langword="false" />.</returns>
        public static bool CreateParticleEffectNonLooped(ParticleEffectAsset asset, string effectName, Entity entity,
            Vector3 off = default, Vector3 rot = default, float scale = 1.0f,
            InvertAxisFlags invertAxis = InvertAxisFlags.None)
        {
            if (!asset.UseNext())
            {
                return false;
            ...
            return Call<bool>(Hash.START_PARTICLE_FX_NON_LOOPED_ON_ENTITY, effectName, entity.Handle, off.X, off.Y,
                off.Z, rot.X, rot.Y, rot.Z, scale, invertAxisFlagX, invertAxisFlagY, invertAxisFlagZ);
        }
        ...
        /// <param name="invertAxis">Which axis to flip the effect in. For a car side exahust you may need to flip in the Y Axis</param>
        /// <returns><see langword="true" />If the effect was able to start; otherwise, <see langword="false" />.</returns>
        public static bool CreateParticleEffectNonLooped(ParticleEffectAsset asset, string effectName,
            EntityBone entityBone, Vector3 off = default, Vector3 rot = default, float scale = 1.0f,
            InvertAxisFlags invertAxis = InvertAxisFlags.None)
        {
            if (!asset.UseNext())
            {
            ...
            return Call<bool>(Hash.START_PARTICLE_FX_NON_LOOPED_ON_ENTITY_BONE, effectName, entityBone.Owner.Handle,
                off.X, off.Y, off.Z, rot.X, rot.Y, rot.Z, entityBone, scale, invertAxisFlagX, invertAxisFlagY,
                invertAxisFlagZ);
        }
        ...
        public static ParticleEffect CreateParticleEffect(ParticleEffectAsset asset, string effectName, Entity entity,
            Vector3 offset = default, Vector3 rotation = default, float scale = 1.0f,
            InvertAxisFlags invertAxis = InvertAxisFlags.None)
        {
        ...
        /// <param name="scale">How much to scale the size of the effect by.</param>
        /// <param name="invertAxis">Which axis to flip the effect in. For a car side exhaust you may need to flip in the Y Axis.</param>
        public static ParticleEffect CreateParticleEffect(ParticleEffectAsset asset, string effectName,
            EntityBone entityBone, Vector3 offset = default, Vector3 rotation = default, float scale = 1.0f,
            InvertAxisFlags invertAxis = InvertAxisFlags.None)
        {
            if (!asset.UseNext())
            {
            ...
            int handle = Call<int>(Hash.START_PARTICLE_FX_LOOPED_ON_ENTITY_BONE, effectName, entityBone.Owner.Handle,
                offset.X, offset.Y, offset.Z, rotation.X, rotation.Y, rotation.Z, entityBone.Index, scale,
                invertAxisFlagX, invertAxisFlagY, invertAxisFlagZ);
            if (handle == 0)
            {
                return null;
            }
        ...
        /// <param name="invertAxis">Which axis to flip the effect in.</param>
        public static ParticleEffect CreateParticleEffect(ParticleEffectAsset asset, string effectName,
            Vector3 position, Vector3 rotation = default, float scale = 1.0f,
            InvertAxisFlags invertAxis = InvertAxisFlags.None)
        {
            if (!asset.UseNext())
            {
            ...
            int handle = Call<int>(Hash.START_PARTICLE_FX_LOOPED_AT_COORD, effectName, position.X, position.Y,
                position.Z, rotation.X, rotation.Y, rotation.Z, scale, invertAxisFlagX, invertAxisFlagY,
                invertAxisFlagZ, false);
            if (handle == 0)
            {
                return null;
            }
        ...
        private static bool HasFlagFast(InvertAxisFlags flagValues, InvertAxisFlags flag) =>
        ...
        {
            Call(Hash.REMOVE_PARTICLE_FX_IN_RANGE, pos.X, pos.Y, pos.Z, range);
        }
        ...
        public static Rope AddRope(RopeType type, Vector3 position, Vector3 rotation, float length, float minLength,
            bool breakable)
        {
            Call(Hash.ROPE_LOAD_TEXTURES);

            return new Rope(Call<int>(Hash.ADD_ROPE, position.X, position.Y, position.Z, rotation.X, rotation.Y,
                rotation.Z, length, type, length, minLength, 0.5f, false, false, true, 1.0f, breakable, 0));
        }
        ...
        public static void ShootBullet(Vector3 sourcePosition, Vector3 targetPosition, Ped owner,
            WeaponAsset weaponAsset, int damage, float speed = -1f)
        {
            Call(Hash.SHOOT_SINGLE_BULLET_BETWEEN_COORDS, sourcePosition.X, sourcePosition.Y, sourcePosition.Z,
                targetPosition.X, targetPosition.Y, targetPosition.Z, damage, 1, weaponAsset.Hash,
                (owner == null ? 0 : owner.Handle), 1, 0, speed);
        }
        ...
        public static void AddExplosion(Vector3 position, ExplosionType type, float radius, float cameraShake,
            Ped owner = null, bool aubidble = true, bool invisible = false)
        {
            if (owner?.Exists() == true)
            {
                Call(Hash.ADD_OWNED_EXPLOSION, owner.Handle, position.X, position.Y, position.Z, type, radius, aubidble,
                    invisible, cameraShake);
            }
            else
            {
                Call(Hash.ADD_EXPLOSION, position.X, position.Y, position.Z, type, radius, aubidble, invisible,
                    cameraShake);
            }
        }
        ...
        public static RelationshipGroup AddRelationshipGroup(string name)
        {
            ...
            unsafe
            {
                Call(Hash.ADD_RELATIONSHIP_GROUP, name, &resultArg);
            }
        ...
        public static void DrawMarker(MarkerType type, Vector3 pos, Vector3 dir, Vector3 rot, Vector3 scale,
            Color color, bool bobUpAndDown = false, bool faceCamera = false, bool rotateY = false,
            string textueDict = null, string textureName = null, bool drawOnEntity = false)
        {
            if (!string.IsNullOrEmpty(textueDict) && !string.IsNullOrEmpty(textureName))
            {
                Call(Hash.DRAW_MARKER, type, pos.X, pos.Y, pos.Z, dir.X, dir.Y, dir.Z, rot.X, rot.Y, rot.Z, scale.X,
                    scale.Y, scale.Z, color.R, color.G, color.B, color.A, bobUpAndDown, faceCamera, 2, rotateY,
                    textueDict,
            ...
            {
                Call(Hash.DRAW_MARKER, type, pos.X, pos.Y, pos.Z, dir.X, dir.Y, dir.Z, rot.X, rot.Y, rot.Z, scale.X,
                    scale.Y, scale.Z, color.R, color.G, color.B, color.A, bobUpAndDown, faceCamera, 2, rotateY, 0, 0,
                    drawOnEntity);
            }
        }
        ...
        {
            Call(Hash.DRAW_LIGHT_WITH_RANGE, position.X, position.Y, position.Z, color.R, color.G, color.B, range,
                intensity);
        }
        ...
        {
            Call(Hash.DRAW_SPOT_LIGHT, pos.X, pos.Y, pos.Z, dir.X, dir.Y, dir.Z, color.R, color.G, color.B, distance,
                brightness, roundness, radius, fadeout);
        }

        public static void DrawSpotLightWithShadow(Vector3 pos, Vector3 dir, Color color, float distance,
            float brightness, float roundness, float radius, float fadeout)
        {
            Call(Hash.DRAW_SHADOWED_SPOT_LIGHT, pos.X, pos.Y, pos.Z, dir.X, dir.Y, dir.Z, color.R, color.G, color.B,
                distance, brightness, roundness, radius, fadeout);
        }

        public static void DrawLine(Vector3 start, Vector3 end, Color color)
        {
            Call(Hash.DRAW_LINE, start.X, start.Y, start.Z, end.X, end.Y, end.Z, color.R, color.G, color.B, color.A);
        }

        public static void DrawPolygon(Vector3 vertexA, Vector3 vertexB, Vector3 vertexC, Color color)
        {
            Call(Hash.DRAW_POLY, vertexA.X, vertexA.Y, vertexA.Z, vertexB.X, vertexB.Y, vertexB.Z, vertexC.X, vertexC.Y,
        ...
        public static void DrawBoxForAngledArea(Vector3 originEdge, Vector3 extentEdge, float width, Color color,
            DrawBoxFlags drawFlags = DrawBoxFlags.OutsideOnly)
        {
        ...
        private static void DrawBoxForAngledAreaOutsideInternal(Vector3 origin, Vector3 extent, float width,
            Color color)
        {
            ...
            DrawQuadPolygonInternal(point1 + normalVector, point2 + normalVector, point3 + normalVector,
                point4 + normalVector, color);
            DrawQuadPolygonInternal(point2 - normalVector, point1 - normalVector, point3 - normalVector,
                point4 - normalVector, color);

            DrawQuadPolygonInternal(point1 + normalVector, point3 - normalVector, point1 - normalVector,
                point3 + normalVector, color);
            DrawQuadPolygonInternal(point2 + normalVector, point4 - normalVector, point2 - normalVector,
                point4 + normalVector, color);

            DrawQuadPolygonInternal(point2 + normalVector, point3 - normalVector, point3 + normalVector,
                point2 - normalVector, color);
            DrawQuadPolygonInternal(point1 + normalVector, point4 - normalVector, point4 + normalVector,
                point1 - normalVector, color);
        }
        ...
        private static void DrawBoxForAngledAreaInsideInternal(Vector3 origin, Vector3 extent, float width, Color color)
        {
            ...
            DrawQuadPolygonInternal(point3 - normalVector, point1 + normalVector, point1 - normalVector,
                point3 + normalVector, color);
            DrawQuadPolygonInternal(point4 - normalVector, point2 + normalVector, point2 - normalVector,
                point4 + normalVector, color);

            DrawQuadPolygonInternal(point3 - normalVector, point2 + normalVector, point3 + normalVector,
                point2 - normalVector, color);
            DrawQuadPolygonInternal(point4 - normalVector, point1 + normalVector, point4 + normalVector,
                point1 - normalVector, color);
        }

        private static void DrawQuadPolygonInternal(Vector3 point1, Vector3 point2, Vector3 point3, Vector3 point4,
            Color color)
        {
        ...
        public static RaycastResult Raycast(Vector3 source, Vector3 target, IntersectFlags options,
            Entity ignoreEntity = null)
        {
            return new RaycastResult(Call<int>(Hash.START_EXPENSIVE_SYNCHRONOUS_SHAPE_TEST_LOS_PROBE, source.X,
                source.Y, source.Z, target.X, target.Y, target.Z, options,
                ignoreEntity == null ? 0 : ignoreEntity.Handle, 7));
        }
        ...
        /// <param name="options">What type of objects the raycast should intersect with.</param>
        /// <param name="ignoreEntity">Specify an <see cref="Entity"/> that the raycast should ignore, leave null for no entities ignored.</param>
        public static RaycastResult Raycast(Vector3 source, Vector3 direction, float maxDistance,
            IntersectFlags options, Entity ignoreEntity = null)
        {
        ...
        /// <param name="ignoreEntity">Specify an <see cref="Entity"/> that the raycast should ignore, leave null for no entities ignored.</param>
        [Obsolete(
            "World.RaycastCapsule is obsolete because the result may not be made in the same frame you call the method. Use ShapeTest.StartTestCapsule instead.")]
        public static RaycastResult RaycastCapsule(Vector3 source, Vector3 target, float radius, IntersectFlags options,
            Entity ignoreEntity = null)
        {
            return new RaycastResult(Call<int>(Hash.START_SHAPE_TEST_CAPSULE, source.X, source.Y, source.Z, target.X,
                target.Y, target.Z, radius, options, ignoreEntity == null ? 0 : ignoreEntity.Handle, 7));
        }
        ...
        [Obsolete(
            "World.RaycastCapsule is obsolete because the result may not be made in the same frame you call the method. Use ShapeTest.StartTestCapsule instead.")]
        public static RaycastResult RaycastCapsule(Vector3 source, Vector3 direction, float maxDistance, float radius,
            IntersectFlags options, Entity ignoreEntity = null)
        {
            Vector3 target = source + direction * maxDistance;
        ...
        {
            return Raycast(GameplayCamera.Position, GameplayCamera.GetOffsetPosition(new Vector3(0f, 1000f, 0f)),
        ...
        /// <returns>A <see cref="RaycastResult"/> containing information about where the crosshair intersects with the world.</returns>
        public static RaycastResult GetCrosshairCoordinates(IntersectFlags intersectOptions = IntersectFlags.Everything,
            Entity ignoreEntity = null)
        {
            return Raycast(GameplayCamera.Position, GameplayCamera.GetOffsetPosition(new Vector3(0f, 1000f, 0f)),
                intersectOptions, ignoreEntity);
        }
        ...
        {
            return Call<float>(Hash.GET_DISTANCE_BETWEEN_COORDS, origin.X, origin.Y, origin.Z, destination.X,
                destination.Y, destination.Z, 1);
        }
        ...
        {
            return Call<float>(Hash.CALCULATE_TRAVEL_DISTANCE_BETWEEN_POINTS, origin.X, origin.Y, origin.Z,
        ...
        public static float GetGroundHeight(Vector3 position)
        {
            ...
            unsafe
            {
                Call(Hash.GET_GROUND_Z_FOR_3D_COORD, position.X, position.Y, position.Z, &resultArg, false);
            }
        ...
        public static Vector3 GetSafeCoordForPed(Vector3 position, bool sidewalk = true, int flags = 0)
        {
            ...
            unsafe
            {
                if (Call<bool>(Hash.GET_SAFE_COORD_FOR_PED, position.X, position.Y, position.Z, sidewalk, &outPos,
                        flags))
                {
                    return outPos;
                }
        ...
        public static Vector3 GetNextPositionOnStreet(Vector3 position, bool unoccupied = false)
        {
            ...
            unsafe
            {
                if (unoccupied)
                {
                    for (int i = 1; i < 40; i++)
                    {
                        Call(Hash.GET_NTH_CLOSEST_VEHICLE_NODE, position.X, position.Y, position.Z, i, &outPos, 1,
                            0x40400000, 0);

                        position = outPos;

                        if (!Call<bool>(Hash.IS_POINT_OBSCURED_BY_A_MISSION_ENTITY, position.X, position.Y, position.Z,
                                5.0f,
                                5.0f, 5.0f, 0))
                        {
                            return position;
                ...
                else if (Call<bool>(Hash.GET_NTH_CLOSEST_VEHICLE_NODE, position.X, position.Y, position.Z, 1, &outPos,
                             1,
                             0x40400000, 0))
                {
                    return outPos;
        ...
        public static Vector3 GetNextPositionOnSidewalk(Vector3 position)
        {
            ...
            unsafe
            {
                if (Call<bool>(Hash.GET_SAFE_COORD_FOR_PED, position.X, position.Y, position.Z, true, &outPos, 0))
                {
                    return outPos;
                }
                else if (Call<bool>(Hash.GET_SAFE_COORD_FOR_PED, position.X, position.Y, position.Z, false, &outPos, 0))
                {
                    return outPos;
                }
            }
        ...
        public static string GetStreetName(Vector3 position)
        {
            ...
            unsafe
            {
                Call(Hash.GET_STREET_NAME_AT_COORD, position.X, position.Y, position.Z, &streetHash, &crossingHash);
            }

            return Call<string>(Hash.GET_STREET_NAME_FROM_HASH_KEY, streetHash);
        }
        ...
        public static string GetStreetName(Vector3 position, out string crossingRoadName)
        {
            ...
            crossingRoadName = Call<string>(Hash.GET_STREET_NAME_FROM_HASH_KEY, crossingHash);
            return Call<string>(Hash.GET_STREET_NAME_FROM_HASH_KEY, streetHash);
        }
        ...
        {
            return Call<string>(Hash.GET_NAME_OF_ZONE, position.X, position.Y, position.Z);
        }
        ...
        /// </returns>
        public static bool IsPointInAngledArea(Vector3 point, Vector3 originEdge, Vector3 extentEdge, float width,
            bool includeZAxis = true)
        {
            return Call<bool>(Hash.IS_POINT_IN_ANGLED_AREA, point.X, point.Y, point.Z, originEdge.X, originEdge.Y,
                originEdge.Z, extentEdge.X, extentEdge.Y, extentEdge.Z, width, false, includeZAxis);
        }
