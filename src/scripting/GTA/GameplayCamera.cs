...
namespace GTA
{
    public static class GameplayCamera
    {
        ...
        /// </summary>
        public static IntPtr MemoryAddress => NativeMemory.GetGameplayCameraAddress();

        /// <summary>
        /// Gets the matrix of the <see cref="GameplayCamera"/>.
        /// </summary>
        public static Matrix Matrix => new(NativeMemory.ReadMatrix(MemoryAddress + 0x1F0));

        /// <summary>
        /// Gets the position of the <see cref="GameplayCamera"/>.
        /// </summary>
        public static Vector3 Position => Call<Vector3>(Hash.GET_GAMEPLAY_CAM_COORD);
        ...
        /// </value>
        public static Vector3 Rotation => Call<Vector3>(Hash.GET_GAMEPLAY_CAM_ROT, 2);
        ...
        /// </summary>
        public static Vector3 UpVector => new(NativeMemory.ReadVector3(MemoryAddress + 0x210));

        /// <summary>
        /// Gets the right vector of the <see cref="GameplayCamera"/>.
        /// </summary>
        public static Vector3 RightVector => new(NativeMemory.ReadVector3(MemoryAddress + 0x1F0));

        /// <summary>
        /// Gets the forward vector of the <see cref="GameplayCamera"/>, see also <seealso cref="Direction"/>.
        /// </summary>
        public static Vector3 ForwardVector => new(NativeMemory.ReadVector3(MemoryAddress + 0x200));
        ...
        {
            Call(Hash.SET_THIRD_PERSON_CAM_RELATIVE_HEADING_LIMITS_THIS_UPDATE, min, max);
        }
        ...
        {
            Call(Hash.SET_THIRD_PERSON_CAM_RELATIVE_PITCH_LIMITS_THIS_UPDATE, min, max);
        }
        ...
        {
            get => Call<float>(Hash.GET_GAMEPLAY_CAM_RELATIVE_PITCH);
            set => Call(Hash.SET_GAMEPLAY_CAM_RELATIVE_PITCH, value, 1f);
        }
        ...
        {
            get => Call<float>(Hash.GET_GAMEPLAY_CAM_RELATIVE_HEADING);
            set => Call(Hash.SET_GAMEPLAY_CAM_RELATIVE_HEADING, value);
        }

        /// <summary>
        /// Gets the zoom of the <see cref="GameplayCamera"/>.
        /// </summary>
        public static float Zoom => Call<float>(Hash.GET_FIRST_PERSON_AIM_CAM_ZOOM_FACTOR);

        /// <summary>
        /// Gets the field of view of the <see cref="GameplayCamera"/>.
        /// </summary>
        public static float FieldOfView => Call<float>(Hash.GET_GAMEPLAY_CAM_FOV);
        ...
        /// </value>
        public static bool IsRendering => Call<bool>(Hash.IS_GAMEPLAY_CAM_RENDERING);
        ...
        /// </value>
        public static bool IsAimCamActive => Call<bool>(Hash.IS_AIM_CAM_ACTIVE);
        ...
        /// <see langword="true" /> if the aiming camera is rendering; otherwise, <see langword="false" />.
        /// </value>
        public static bool IsFirstPersonAimCamActive => Call<bool>(Hash.IS_FIRST_PERSON_AIM_CAM_ACTIVE);
        ...
        /// </value>
        public static bool IsLookingBehind => Call<bool>(Hash.IS_GAMEPLAY_CAM_LOOKING_BEHIND);
        ...
        {
            Call(Hash.SHAKE_GAMEPLAY_CAM, Camera.shakeNames[(int)shakeType], amplitude);
        }
        ...
        {
            Call(Hash.STOP_GAMEPLAY_CAM_SHAKING, true);
        }
        ...
        /// </value>
        public static bool IsShaking => Call<bool>(Hash.IS_GAMEPLAY_CAM_SHAKING);
        ...
        {
            set => Call(Hash.SET_GAMEPLAY_CAM_SHAKE_AMPLITUDE, value);
        }
    }
}