...
namespace GTA
{
    public class InteriorProxy : INativeValue, IExistable
    {
        ...
        public static InteriorProxy FromHandle(int handle) =>
            NativeMemory.InteriorProxyHandleExists(handle) ? new InteriorProxy(handle) : null;
        ...
        /// </summary>
        public IntPtr MemoryAddress => NativeMemory.GetInteriorProxyAddress(Handle);
        ...
        public InteriorInstance CurrentInteriorInstance
        {
            get
            {
                ...
                var interiorInstHandle = NativeMemory.GetAssociatedInteriorInstHandleFromInteriorProxy(Handle);
        ...
        public Model Model
        {
            get
            {
                ...
                return new Model(NativeMemory.ReadInt32(address + 0xE4));
            }
        }
        ...
        /// </value>
        public bool IsDisabled => Call<bool>(Hash.IS_INTERIOR_DISABLED, Handle);
        ...
        /// </value>
        public bool IsCapped => Call<bool>(Hash.IS_INTERIOR_CAPPED, Handle);
        ...
        public void Refresh()
        {
            Call(Hash.REFRESH_INTERIOR, Handle);
        }
        ...
        {
            Call(Hash.DISABLE_INTERIOR, Handle, toggle);
        }
        ...
        {
            Call(Hash.CAP_INTERIOR, Handle, toggle);
        }
        ...
        {
            Call(Hash.PIN_INTERIOR_IN_MEMORY, Handle);
        }
        ...
        {
            Call(Hash.UNPIN_INTERIOR, Handle);
        }

        static public InteriorProxy GetInteriorProxyAt(Vector3 position)
        {
            return FromHandle(Call<int>(Hash.GET_INTERIOR_AT_COORDS, position.X, position.Y, position.Z));
        }
        ...
        {
            var interiorInstHandle = NativeMemory.GetInteriorProxyHandleFromGameplayCam();
        ...
        public bool Exists()
        {
            return NativeMemory.InteriorProxyHandleExists(Handle);
        }
