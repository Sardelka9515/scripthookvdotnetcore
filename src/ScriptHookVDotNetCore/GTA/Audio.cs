...
namespace GTA
{
    ...
    public static class Audio
    {
        ...
        {
            Call(Hash.TRIGGER_MUSIC_EVENT, musicFile);
        }
        ...
        {
            Call(Hash.CANCEL_MUSIC_EVENT, musicFile);
        }
        ...
        {
            var id = Call<int>(Hash.GET_SOUND_ID);
            Call(Hash.PLAY_SOUND_FROM_ENTITY, id, soundFile, entity.Handle, 0, 0, 0);
            return id;
        }
        ...
        {
            var id = Call<int>(Hash.GET_SOUND_ID);
            Call(Hash.PLAY_SOUND_FROM_ENTITY, id, soundFile, entity.Handle, soundSet, 0, 0);
            return id;
        }
        ...
        {
            var id = Call<int>(Hash.GET_SOUND_ID);
            Call(Hash.PLAY_SOUND_FROM_COORD, id, soundFile, position.X, position.Y, position.Z, 0, 0, 0, 0);
            return id;
        }
        ...
        {
            var id = Call<int>(Hash.GET_SOUND_ID);
            Call(Hash.PLAY_SOUND_FROM_COORD, id, soundFile, position.X, position.Y, position.Z, soundSet, 0, 0, 0);
            return id;
        }
        ...
        {
            var id = Call<int>(Hash.GET_SOUND_ID);
            Call(Hash.PLAY_SOUND_FRONTEND, id, soundFile, 0, 0);
            return id;
        }
        ...
        {
            var id = Call<int>(Hash.GET_SOUND_ID);
            Call(Hash.PLAY_SOUND_FRONTEND, id, soundFile, soundSet, 0);
            return id;
        }
        ...
        {
            return Call<bool>(Hash.HAS_SOUND_FINISHED, id);
        }
        ...
        {
            Call(Hash.SET_AUDIO_FLAG, flag.ToString(), toggle);
        }
