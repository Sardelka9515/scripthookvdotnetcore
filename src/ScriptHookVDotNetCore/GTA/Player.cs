...
namespace GTA
{
    public sealed class Player : INativeValue
    {
        ...
        public Ped Character
        {
            get
            {
                int handle = Call<int>(Hash.GET_PLAYER_PED, Handle);
        ...
        /// </summary>
        public string Name => Call<string>(Hash.GET_PLAYER_NAME, Handle);
        ...
        public int Money
        {
            get
            {
                ...
                unsafe
                {
                    Call(Hash.STAT_GET_INT, stat, &result, -1);
                }
            ...
            set
            {
                ...
                Call(Hash.STAT_SET_INT, stat, value, 1);
            }
        }
        ...
        {
            get => Call<int>(Hash.GET_PLAYER_WANTED_LEVEL, Handle);
            set
            {
                Call(Hash.SET_PLAYER_WANTED_LEVEL, Handle, value, false);
                Call(Hash.SET_PLAYER_WANTED_LEVEL_NOW, Handle, false);
            }
        }
        ...
        {
            get => Call<Vector3>(Hash.GET_PLAYER_WANTED_CENTRE_POSITION, Handle);
            set => Call(Hash.SET_PLAYER_WANTED_CENTRE_POSITION, Handle, value.X, value.Y, value.Z);
        }
        ...
        public int MaxArmor
        {
            get => Call<int>(Hash.GET_PLAYER_MAX_ARMOUR, Handle);
            set => Call(Hash.SET_PLAYER_MAX_ARMOUR, Handle, value);
        }
        ...
        public ParachuteTint PrimaryParachuteTint
        {
            get
            {
                ...
                unsafe
                {
                    Call(Hash.GET_PLAYER_PARACHUTE_TINT_INDEX, Handle, &result);
                }

                return (ParachuteTint)result;
            }
            set => Call(Hash.SET_PLAYER_PARACHUTE_TINT_INDEX, Handle, value);
        }
        ...
        public ParachuteTint ReserveParachuteTint
        {
            get
            {
                ...
                unsafe
                {
                    Call(Hash.GET_PLAYER_RESERVE_PARACHUTE_TINT_INDEX, Handle, &result);
                }

                return (ParachuteTint)result;
            }
            set => Call(Hash.SET_PLAYER_RESERVE_PARACHUTE_TINT_INDEX, Handle, value);
        }
        ...
        {
            set => Call(Hash.SET_PLAYER_CAN_LEAVE_PARACHUTE_SMOKE_TRAIL, Handle, value);
        }
        ...
        public Color ParachuteSmokeTrailColor
        {
            get
            {
                ...
                unsafe
                {
                    Call(Hash.GET_PLAYER_PARACHUTE_SMOKE_TRAIL_COLOR, Handle, &r, &g, &b);
                }

                return Color.FromArgb(r, g, b);
            }
            set => Call(Hash.SET_PLAYER_PARACHUTE_SMOKE_TRAIL_COLOR, Handle, value.R, value.G, value.B);
        }
        ...
        /// </value>
        public bool IsDead => Call<bool>(Hash.IS_PLAYER_DEAD, Handle);
        ...
        /// </value>
        public bool IsAiming => Call<bool>(Hash.IS_PLAYER_FREE_AIMING, Handle);
        ...
        /// </value>
        public bool IsClimbing => Call<bool>(Hash.IS_PLAYER_CLIMBING, Handle);
        ...
        /// </value>
        public bool IsRidingTrain => Call<bool>(Hash.IS_PLAYER_RIDING_TRAIN, Handle);
        ...
        /// </value>
        public bool IsPressingHorn => Call<bool>(Hash.IS_PLAYER_PRESSING_HORN, Handle);
        ...
        /// </value>
        public bool IsPlaying => Call<bool>(Hash.IS_PLAYER_PLAYING, Handle);
        ...
        {
            get => Call<bool>(Hash.GET_PLAYER_INVINCIBLE, Handle);
            set => Call(Hash.SET_PLAYER_INVINCIBLE, Handle, value);
        }
        ...
        {
            set => Call(Hash.SET_POLICE_IGNORE_PLAYER, Handle, value);
        }
        ...
        {
            set => Call(Hash.SET_EVERYONE_IGNORE_PLAYER, Handle, value);
        }
        ...
        {
            set => Call(Hash.SET_DISPATCH_COPS_FOR_PLAYER, Handle, value);
        }
        ...
        {
            set => Call(Hash.SET_PLAYER_CAN_USE_COVER, Handle, value);
        }
        ...
        {
            get => Call<bool>(Hash.CAN_PLAYER_START_MISSION, Handle);
        }
        ...
        {
            set => Call(Hash.GIVE_PLAYER_RAGDOLL_CONTROL, Handle, value);
        }
        ...
        {
            get => Call<bool>(Hash.IS_PLAYER_CONTROL_ON, Handle);
            set => Call(Hash.SET_PLAYER_CONTROL, Handle, value, 0);
        }
        ...
        public bool ChangeModel(Model model)
        {
            ...
            Call(Hash.SET_PLAYER_MODEL, Handle, model.Hash);
        ...
        /// </summary>
        public float RemainingSprintTime => Call<float>(Hash.GET_PLAYER_SPRINT_TIME_REMAINING, Handle);

        /// <summary>
        /// Gets how much sprint stamina this <see cref="Player"/> currently has.
        /// </summary>
        public float RemainingSprintStamina => Call<float>(Hash.GET_PLAYER_SPRINT_STAMINA_REMAINING, Handle);

        /// <summary>
        /// Gets how long this <see cref="Player"/> can stay underwater before they start losing health.
        /// </summary>
        public float RemainingUnderwaterTime => Call<float>(Hash.GET_PLAYER_UNDERWATER_TIME_REMAINING, Handle);
        ...
        /// </value>
        public bool IsSpecialAbilityActive => Call<bool>(Hash.IS_SPECIAL_ABILITY_ACTIVE, Handle);
        ...
        {
            get => Call<bool>(Hash.IS_SPECIAL_ABILITY_ENABLED, Handle);
            set => Call(Hash.ENABLE_SPECIAL_ABILITY, Handle, value);
        }
        ...
        {
            Call(Hash.SPECIAL_ABILITY_CHARGE_ABSOLUTE, Handle, absoluteAmount, true);
        }
        ...
        {
            Call(Hash.SPECIAL_ABILITY_CHARGE_NORMALIZED, Handle, normalizedRatio, true);
        }
        ...
        {
            Call(Hash.SPECIAL_ABILITY_FILL_METER, Handle, 1);
        }
        ...
        {
            Call(Hash.SPECIAL_ABILITY_DEPLETE_METER, Handle, 1);
        }
        ...
        public Vehicle LastVehicle => Call<Vehicle>(Hash.GET_PLAYERS_LAST_VEHICLE);
        ...
        {
            return Call<bool>(Hash.IS_PLAYER_FREE_AIMING_AT_ENTITY, Handle, entity.Handle);
        }
        ...
        /// </value>
        public bool IsTargetingAnything => Call<bool>(Hash.IS_PLAYER_TARGETTING_ANYTHING, Handle);
        ...
        public Entity TargetedEntity
        {
            get
            {
                ...
                unsafe
                {
                    if (Call<bool>(Hash.GET_ENTITY_PLAYER_IS_FREE_AIMING_AT, Handle, &entityHandle))
                    {
        ...
        public Entity LockedOnEntity
        {
            get
            {
                ...
                unsafe
                {
                    if (Call<bool>(Hash.GET_PLAYER_TARGET_ENTITY, Handle, &entityHandle))
                    {
                        return Entity.FromHandle(entityHandle);
                    }
                }
        ...
        {
            set => Call(Hash.SET_PLAYER_FORCED_AIM, Handle, value);
        }
        ...
        {
            Call(Hash.DISABLE_PLAYER_FIRING, Handle, 0);
        }
        ...
        public void SetRunSpeedMultThisFrame(float mult)
        {
            ...
            Call(Hash.SET_RUN_SPRINT_MULTIPLIER_FOR_PLAYER, Handle, mult);
        }
        ...
        public void SetSwimSpeedMultThisFrame(float mult)
        {
            ...
            Call(Hash.SET_SWIM_MULTIPLIER_FOR_PLAYER, Handle, mult);
        }
        ...
        {
            Call(Hash.SET_FIRE_AMMO_THIS_FRAME, Handle);
        }
        ...
        {
            Call(Hash.SET_EXPLOSIVE_AMMO_THIS_FRAME, Handle);
        }
        ...
        {
            Call(Hash.SET_EXPLOSIVE_MELEE_THIS_FRAME, Handle);
        }
        ...
        {
            Call(Hash.SET_SUPER_JUMP_THIS_FRAME, Handle);
        }
        ...
        {
            Call(Hash.SET_PLAYER_MAY_NOT_ENTER_ANY_VEHICLE, Handle);
        }
        ...
        {
            Call(Hash.SET_PLAYER_MAY_ONLY_ENTER_THIS_VEHICLE, Handle, vehicle.Handle);
        }
