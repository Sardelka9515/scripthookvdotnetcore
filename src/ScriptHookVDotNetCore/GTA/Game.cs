...
namespace GTA
{
    public static class Game
    {
        ...
        public static Player Player
        {
            get
            {
                int handle = Call<int>(Hash.PLAYER_ID);
        ...
        /// </summary>
        public static Blip PlayerBlip => new(Call<int>(Hash.GET_MAIN_PLAYER_BLIP_ID));

        /// <summary>
        /// Gets the north blip, which is shown on the radar.
        /// </summary>
        public static Blip NorthBlip => Version >= GameVersion.v1_0_463_1_Steam
            ? new Blip(Call<int>(Hash.GET_NORTH_BLID_INDEX))
            : new Blip(NativeMemory.GetNorthBlip());

        /// <summary>
        /// Gets the current game language.
        /// </summary>
        public static Language Language => Call<Language>(Hash.GET_CURRENT_LANGUAGE);

        /// <summary>
        /// Gets the version of the game.
        /// </summary>
        public static GameVersion Version => (GameVersion)NativeMemory.GetGameVersion();

        /// <summary>
        /// Gets the measurement system the game uses to display.
        /// </summary>
        public static MeasurementSystem MeasurementSystem => Call<bool>(Hash.SHOULD_USE_METRIC_MEASUREMENTS)
        ...
        /// </summary>
        public static int GameTime => Call<int>(Hash.GET_GAME_TIMER);
        ...
        {
            get => NativeMemory.TimeScale;
            set => Call(Hash.SET_TIME_SCALE, value);
        }

        /// <summary>
        /// Gets the total number of frames that have been rendered in this session.
        /// </summary>
        public static int FrameCount => Call<int>(Hash.GET_FRAME_COUNT);
        ...
        /// </summary>
        public static float LastFrameTime => Call<float>(Hash.GET_FRAME_TIME);
        ...
        {
            get => Call<int>(Hash.GET_MAX_WANTED_LEVEL);
            set
            {
                if (value < 0)
                {
                ...
                Call(Hash.SET_MAX_WANTED_LEVEL, value);
            }
        }
        ...
        public static RadioStation RadioStation
        {
            get
            {
                string radioName = Call<string>(Hash.GET_PLAYER_RADIO_STATION_NAME);
            ...
            set
            {
                ...
                {
                    Call(Hash.SET_RADIO_TO_STATION_NAME, radioNames[(int)value]);
                }
                else
                {
                    Function.Call(Hash.SET_RADIO_TO_STATION_NAME, NullString);
                }
            }
        }
        ...
        {
            get => Call<bool>(Hash.GET_USINGNIGHTVISION);
            set => Call(Hash.SET_NIGHTVISION, value);
        }
        ...
        {
            get => Call<bool>(Hash.GET_USINGSEETHROUGH);
            set => Call(Hash.SET_SEETHROUGH, value);
        }
        ...
        {
            get => Call<bool>(Hash.GET_MISSION_FLAG);
            set => Call(Hash.SET_MISSION_FLAG, value);
        }
        ...
        {
            get => Call<bool>(Hash.GET_RANDOM_EVENT_FLAG);
            set => Call(Hash.SET_RANDOM_EVENT_FLAG, value);
        }

        /// <summary>
        /// Gets a value indicating whether the cutscene is active.
        /// </summary>
        public static bool IsCutsceneActive => Call<bool>(Hash.IS_CUTSCENE_ACTIVE);

        /// <summary>
        /// Gets a value indicating whether there is a waypoint set on the map.
        /// </summary>
        public static bool IsWaypointActive => Call<bool>(Hash.IS_WAYPOINT_ACTIVE);
        ...
        {
            Call(Hash.SET_SAVE_MENU_ACTIVE, true);
        }
        ...
        {
            get => Call<bool>(Hash.IS_PAUSE_MENU_ACTIVE);
            set => Call(Hash.SET_PAUSE_MENU_ACTIVE, value);
        }
        ...
        {
            Call(Hash.SET_GAME_PAUSED, value);
        }

        /// <summary>
        /// Gets a value indicating whether there is a loading screen being displayed.
        /// </summary>
        public static bool IsLoading => Call<bool>(Hash.GET_IS_LOADING_SCREEN_ACTIVE);
        ...
        {
            Core.PauseKeyEvents(true);

            Function.Call(Hash.DISPLAY_ONSCREEN_KEYBOARD, true, windowTitles[(int)windowTitle], NullString, defaultText,
                NullString, NullString, NullString, maxLength + 1);

            while (Call<int>(Hash.UPDATE_ONSCREEN_KEYBOARD) == 0)
            {
                Script.Yield();
            }

            Core.PauseKeyEvents(false);

            return Call<string>(Hash.GET_ONSCREEN_KEYBOARD_RESULT);
        }
        ...
        {
            return Call<bool>(Hash.HAS_PC_CHEAT_WITH_HASH_BEEN_ACTIVATED, GenerateHash(cheat));
        }
        ...
        public static bool WasButtonCombinationJustEntered(params Button[] buttons)
        {
            ...
            return Call<bool>(Hash.HAS_CHEAT_WITH_HASH_BEEN_ACTIVATED, hash, buttons.Length);
        }

        /// <summary>
        /// Gets whether the last input was made with a GamePad or keyboard and mouse.
        /// </summary>
        public static InputMethod LastInputMethod => Call<bool>(Hash.IS_USING_KEYBOARD_AND_MOUSE, 2)
        ...
        {
            return Call<int>(Hash.GET_CONTROL_VALUE, 0, control);
        }
        ...
        {
            return Call<float>(Hash.GET_CONTROL_NORMAL, 0, control);
        }
        ...
        {
            return Call<float>(Hash.GET_DISABLED_CONTROL_NORMAL, 0, control);
        }
        ...
        {
            Call(Hash.SET_CONTROL_VALUE_NEXT_FRAME, 0, control, value);
        }
        ...
        {
            return Call<bool>(Hash.IS_DISABLED_CONTROL_PRESSED, 0, control);
        }
        ...
        {
            return Call<bool>(Hash.IS_DISABLED_CONTROL_JUST_PRESSED, 0, control);
        }
        ...
        {
            return Call<bool>(Hash.IS_DISABLED_CONTROL_JUST_RELEASED, 0, control);
        }
        ...
        {
            return Call<bool>(Hash.IS_CONTROL_PRESSED, 0, control);
        }
        ...
        {
            return Call<bool>(Hash.IS_CONTROL_JUST_PRESSED, 0, control);
        }
        ...
        {
            return Call<bool>(Hash.IS_CONTROL_JUST_RELEASED, 0, control);
        }
        ...
        {
            return Call<bool>(Hash.IS_CONTROL_ENABLED, 0, control);
        }
        ...
        {
            Call(Hash.ENABLE_CONTROL_ACTION, 0, control, true);
        }
        ...
        {
            Call(Hash.DISABLE_CONTROL_ACTION, 0, control, true);
        }
        ...
        {
            Call(Hash.ENABLE_ALL_CONTROL_ACTIONS, 0);
        }
        ...
        {
            Call(Hash.DISABLE_ALL_CONTROL_ACTIONS, 0);
        }
        ...
        public static int GenerateHash(string input)
        {
            ...
            return unchecked((int)NativeMemory.GetHashKey(input));
        }
        ...
        {
            return Call<bool>(Hash.DOES_TEXT_LABEL_EXIST, entry)
                ? Call<string>(Hash.GET_FILENAME_FOR_AUDIO_CONVERSATION, entry)
                : string.Empty;
        }
        ...
        {
            return NativeMemory.GetGXTEntryByHash(entryLabelHash);
        }
        ...
        {
            return Call<int>(Hash.GET_PROFILE_SETTING, index);
        }
        ...
        public static IntPtr FindPattern(string pattern, string mask, IntPtr startAddress = default)
        {
            unsafe
            {
                byte* address = (startAddress == IntPtr.Zero
                    ? NativeMemory.FindPattern(pattern, mask)
                    : NativeMemory.FindPattern(pattern, mask, startAddress));
