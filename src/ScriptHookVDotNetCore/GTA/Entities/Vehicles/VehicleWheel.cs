...
#pragma warning restore CS0618
        ...
        /// </summary>
        [Obsolete(
            "VehicleWheel.Index does not support any of the wheels wheel_lm2, wheel_rm2, wheel_lm3, or wheel_lm3, but provided for legacy scripts compatibility in v3 API. Use VehicleWheel.BoneId instead.")]
        ...
        public Vector3 LastContactPosition
        {
            get
            {
                ...
                return new Vector3(NativeMemory.ReadVector3(address + 0x40));
            }
        }
        ...
        public float SteeringLimitMultiplier
        {
            ...
            {
                var address = MemoryAddress;
                if (address == IntPtr.Zero || NativeMemory.VehicleWheelSteeringLimitMultiplierOffset == 0)
                    return 0f;

                return NativeMemory.ReadFloat(address + NativeMemory.VehicleWheelSteeringLimitMultiplierOffset);
            }
            set
            {
                var address = MemoryAddress;
                ...
                NativeMemory.WriteFloat(address + NativeMemory.VehicleWheelSteeringLimitMultiplierOffset, value);
            }
        }
        ...
        public float Temperature
        {
            ...
            {
                var address = MemoryAddress;
                if (address == IntPtr.Zero || NativeMemory.VehicleWheelTemperatureOffset == 0)
                    return 0f;

                return NativeMemory.ReadFloat(address + NativeMemory.VehicleWheelTemperatureOffset);
            }
            set
            {
                var address = MemoryAddress;
                ...
                NativeMemory.WriteFloat(address + NativeMemory.VehicleWheelTemperatureOffset, value);
            }
        }
        ...
        public bool IsTouchingSurface
        {
            get
            {
                ...
                return NativeMemory.IsWheelTouchingSurface(address, Vehicle.MemoryAddress);
            }
        }
        ...
        public bool IsTireOnFire
        {
            ...
            {
                var address = MemoryAddress;
                if (address == IntPtr.Zero || NativeMemory.VehicleWheelTouchingFlagsOffset == 0)
                    return false;

                return NativeMemory.IsBitSet(address + NativeMemory.VehicleWheelTouchingFlagsOffset, 3);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (value)
                {
                    NativeMemory.SetBit(address + NativeMemory.VehicleWheelTouchingFlagsOffset, 3);
                }
                else
                {
                    NativeMemory.ClearBit(address + NativeMemory.VehicleWheelTouchingFlagsOffset, 3);
                }
            }
        }
        ...
        public bool IsSteeringWheel
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + NativeMemory.VehicleWheelTouchingFlagsOffset + 4, 3);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (value)
                {
                    NativeMemory.SetBit(address + NativeMemory.VehicleWheelTouchingFlagsOffset + 4, 3);
                }
                else
                {
                    NativeMemory.ClearBit(address + NativeMemory.VehicleWheelTouchingFlagsOffset + 4, 3);
                }
            }
        }
        ...
        public bool IsDrivingWheel
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + NativeMemory.VehicleWheelTouchingFlagsOffset + 4, 4);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (value)
                {
                    NativeMemory.SetBit(address + NativeMemory.VehicleWheelTouchingFlagsOffset + 4, 4);
                }
                else
                {
                    NativeMemory.ClearBit(address + NativeMemory.VehicleWheelTouchingFlagsOffset + 4, 4);
                }
            }
        }
        ...
        public bool IsPunctured
        {
            ...
            {
                var address = MemoryAddress;
                if (address == IntPtr.Zero || NativeMemory.VehicleTireHealthOffset == 0)
                    return false;

                return NativeMemory.ReadFloat(address + NativeMemory.VehicleWheelHealthOffset) < 1000f;
            }
        }
        ...
        public bool IsBursted
        {
            get
            {
                ...
                return NativeMemory.ReadFloat(address + NativeMemory.VehicleTireHealthOffset) <= 0f;
            }
        }
        ...
        public float Health
        {
            ...
            {
                var address = MemoryAddress;
                if (address == IntPtr.Zero || NativeMemory.VehicleWheelHealthOffset == 0)
                    return 0f;

                return NativeMemory.ReadFloat(address + NativeMemory.VehicleWheelHealthOffset);
            }
            set
            {
                var address = MemoryAddress;
                ...
                NativeMemory.WriteFloat(address + NativeMemory.VehicleWheelHealthOffset, value);
            }
        }
        ...
        public float TireHealth
        {
            get
            {
                ...
                return NativeMemory.ReadFloat(address + NativeMemory.VehicleTireHealthOffset);
            }
            set
            {
                var address = MemoryAddress;
                ...
                NativeMemory.WriteFloat(address + NativeMemory.VehicleTireHealthOffset, value);
            }
        }
        ...
        public float WearMultiplier
        {
            get
            {
                ...
                var address = MemoryAddress;
                if (address == IntPtr.Zero || NativeMemory.VehicleTireWearMultiplierOffset == 0)
                    return 0f;

                return NativeMemory.ReadFloat(address + NativeMemory.VehicleTireWearMultiplierOffset);
            }
            set
            {
                if (Game.Version < GameVersion.v1_0_1868_0_Steam)
                    throw new GameVersionNotSupportedException(GameVersion.v1_0_1868_0_Steam, nameof(VehicleWheel),
                        nameof(WearMultiplier));

                var address = MemoryAddress;
                if (address == IntPtr.Zero || NativeMemory.VehicleTireWearMultiplierOffset == 0)
                    return;

                NativeMemory.WriteFloat(address + NativeMemory.VehicleTireWearMultiplierOffset, value);
            }
        }
        ...
        public void Fix(bool leaveOtherBurstedTiresNotShowing)
        {
            ...
            NativeMemory.FixVehicleWheel(address);

            if (!leaveOtherBurstedTiresNotShowing)
            {
                var customShaderEffectVehicleAddr =
                    NativeMemory.ReadAddress(NativeMemory.ReadAddress(Vehicle.MemoryAddress + 0x48) + 0x20);
                NativeMemory.ClearBit(
                    customShaderEffectVehicleAddr + NativeMemory.ShouldShowOnlyVehicleTiresWithPositiveHealthOffset, 1);
            }
        }
        ...
        public void Puncture(float damage = 1000f)
        {
            ...
            NativeMemory.PunctureTire(address, damage, Vehicle.MemoryAddress);
        }
        ...
        public void Burst()
        {
            ...
            NativeMemory.BurstTireOnRim(address, Vehicle.MemoryAddress);
        }
        ...
        private IntPtr GetMemoryAddressInit()
        {
            ...
            var wheelIndexOfArrayPtr =
                NativeMemory.ReadByte(vehicleAddr + NativeMemory.WheelBoneIdToPtrArrayIndexOffset + ((int)BoneId - 11));
            if (wheelIndexOfArrayPtr == 0xFF)
                return IntPtr.Zero;

            var vehicleWheelArrayAddr = NativeMemory.ReadAddress(vehicleAddr + NativeMemory.WheelPtrArrayOffset);
            _cachedAddress = NativeMemory.ReadAddress(vehicleWheelArrayAddr + 0x8 * wheelIndexOfArrayPtr);
