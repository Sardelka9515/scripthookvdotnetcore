...
namespace GTA
{
    public class InteriorInstance : IExistable
    {
        ...
        public static InteriorInstance FromHandle(int handle) =>
            NativeMemory.InteriorInstHandleExists(handle) ? new InteriorInstance(handle) : null;
        ...
        /// </summary>
        public IntPtr MemoryAddress => NativeMemory.GetInteriorInstAddress(Handle);
        ...
        public Model Model
        {
            get
            {
                ...
                return new Model(NativeMemory.GetModelHashFromEntity(address));
            }
        }
        ...
        public Matrix Matrix
        {
            get
            {
                ...
                return new Matrix(NativeMemory.ReadMatrix(address + 0x60));
            }
        }
        ...
        public Vector3 Rotation
        {
            get
            {
                ...
                unsafe
                {
                    ...
                    NativeMemory.GetRotationFromMatrix(tempRotationArray, address + 0x60);
        ...
        public Quaternion Quaternion
        {
            get
            {
                ...
                unsafe
                {
                    ...
                    NativeMemory.GetQuaternionFromMatrix(tempRotationArray, address + 0x60);

                    return new Quaternion(tempRotationArray[0], tempRotationArray[1], tempRotationArray[2],
                        tempRotationArray[3]);
                }
            }
        }
        ...
        public Vector3 Position
        {
            get
            {
                ...
                return new Vector3(NativeMemory.ReadVector3(address + 0x90));
            }
        }
        ...
        public InteriorProxy InteriorProxy
        {
            get
            {
                ...
                var interiorProxyHandle = NativeMemory.GetInteriorProxyHandleFromInteriorInst(Handle);
        ...
        public bool Exists()
        {
            return NativeMemory.InteriorInstHandleExists(Handle);
        }
