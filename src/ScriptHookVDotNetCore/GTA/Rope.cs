...
namespace GTA
{
    public sealed class Rope : PoolObject
    {
        ...
        /// </summary>
        public int VertexCount => Call<int>(Hash.GET_ROPE_VERTEX_COUNT, Handle);
        ...
        public float Length
        {
            get => Call<float>(Hash.ROPE_GET_DISTANCE_BETWEEN_ENDS, Handle);
            set => Call(Hash.ROPE_FORCE_LENGTH, Handle, value);
        }
        ...
        {
            Call(Hash.ACTIVATE_PHYSICS, Handle);
        }
        ...
        {
            Call(Hash.ATTACH_ROPE_TO_ENTITY, Handle, entity.Handle, position.X, position.Y, position.Z, 0);
        }
        ...
        {
            Call(Hash.DETACH_ROPE_FROM_ENTITY, Handle, entity.Handle);
        }
        ...
        {
            Call(Hash.ATTACH_ENTITIES_TO_ROPE, Handle, entity1.Handle, entity2.Handle, position1.X, position1.Y,
                position1.Z, position2.X, position2.Y, position2.Z, length, 0, 0, 0, 0);
        }
        ...
        {
            Call(Hash.PIN_ROPE_VERTEX, Handle, vertex, position.X, position.Y, position.Z);
        }
        ...
        {
            Call(Hash.UNPIN_ROPE_VERTEX, Handle, vertex);
        }
        ...
        {
            return Call<Vector3>(Hash.GET_ROPE_VERTEX_COORD, Handle, vertex);
        }
        ...
        public override bool Exists()
        {
            ...
            unsafe
            {
                return Call<bool>(Hash.DOES_ROPE_EXIST, &handle);
            }
        }
