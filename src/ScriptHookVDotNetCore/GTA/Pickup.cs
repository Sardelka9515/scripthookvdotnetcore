...
namespace GTA
{
    public sealed class Pickup : PoolObject
    {
        ...
        /// </summary>
        public Vector3 Position => Call<Vector3>(Hash.GET_PICKUP_COORDS, Handle);

        /// <summary>
        /// Gets if this <see cref="Pickup"/> has been collected.
        /// </summary>
        public bool IsCollected => Call<bool>(Hash.HAS_PICKUP_BEEN_COLLECTED, Handle);
        ...
        {
            return Call<bool>(Hash.DOES_PICKUP_OBJECT_EXIST, Handle);
        }
        ...
        {
            Call(Hash.REMOVE_PICKUP, Handle);
        }
        ...
        {
            return Call<bool>(Hash.DOES_PICKUP_EXIST, Handle);
        }
