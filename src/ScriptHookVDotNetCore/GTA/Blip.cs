...
namespace GTA
{
    public sealed class Blip : PoolObject
    {
        ...
        public int Type
        {
            get => Call<int>(Hash.GET_BLIP_INFO_ID_TYPE, Handle);
        }
        ...
        public BlipDisplayType DisplayType
        {
            get
            {
                ...
                return (BlipDisplayType)NativeMemory.ReadByte(address + offset);
            }
            set => Call<int>(Hash.SET_BLIP_DISPLAY, Handle, value);
        }
        ...
        public BlipCategoryType CategoryType
        {
            get
            {
                ...
                return (BlipCategoryType)NativeMemory.ReadByte(address + offset);
            }
            set => Call<int>(Hash.SET_BLIP_CATEGORY, Handle, value);
        }
        ...
        public int Alpha
        {
            get => Call<int>(Hash.GET_BLIP_ALPHA, Handle);
            set => Call(Hash.SET_BLIP_ALPHA, Handle, value);
        }
        ...
        public int Priority
        {
            ...
            set => Call(Hash.SET_BLIP_PRIORITY, Handle, value);
        }
        ...
        public int NumberLabel
        {
            get
            {
                ...
                var returnValue = (int)NativeMemory.ReadByte(address + offset);
            ...
            set => Call(Hash.SHOW_NUMBER_ON_BLIP, Handle, value);
        }
        ...
        {
            Call(Hash.HIDE_NUMBER_ON_BLIP, Handle);
        }
        ...
        {
            get => (BlipColor)Call<int>(Hash.GET_BLIP_COLOUR, Handle);
            set => Call(Hash.SET_BLIP_COLOUR, Handle, value);
        }
        ...
        public Color SecondaryColor
        {
            get
            {
                ...
                return System.Drawing.Color.FromArgb(NativeMemory.ReadInt32(address + 0x4C));
            }
            set => Call(Hash.SET_BLIP_SECONDARY_COLOUR, Handle, value.R, value.G, value.B);
        }
        ...
        {
            get => (BlipSprite)Call<int>(Hash.GET_BLIP_SPRITE, Handle);
            set => Call(Hash.SET_BLIP_SPRITE, Handle, value);
        }
        ...
        public string Name
        {
            get
            {
                ...
                var nameLength = (ushort)NativeMemory.ReadInt16(address + 0x30);
                ...
                return nameLength != 0 ? PtrToStringUTF8(NativeMemory.ReadAddress(address + 0x28)) : string.Empty;
            }
            set
            {
                Function.Call(Hash.BEGIN_TEXT_COMMAND_SET_BLIP_NAME, StringString);
                Call(Hash.ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME, value);
                Call(Hash.END_TEXT_COMMAND_SET_BLIP_NAME, Handle);
            }
        }
        ...
        public int DisplayNameHash
        {
            get
            {
                ...
                return NativeMemory.ReadInt32(address + 0x38);
            }
            set
            {
                var address = MemoryAddress;
                ...
                NativeMemory.WriteInt32(address + 0x38, value);
            }
        }
        ...
        {
            get => Call<Vector3>(Hash.GET_BLIP_INFO_ID_COORD, Handle);
            set => Call(Hash.SET_BLIP_COORDS, Handle, value.X, value.Y, value.Z);
        }
        ...
        public int Rotation
        {
            get
            {
                if (Game.Version >= GameVersion.v1_0_2060_1_Steam)
                    return Call<int>(Hash.GET_BLIP_ROTATION, Handle);
                ...
                if (gameVersion >= GameVersion.v1_0_944_2_Steam)
                    return (int)NativeMemory.ReadFloat(address + 0x58);

                var offset = gameVersion >= GameVersion.v1_0_463_1_Steam ? 0x58 : 0x54;
                return NativeMemory.ReadInt16(address + offset);
            }
            set => Call(Hash.SET_BLIP_ROTATION, Handle, value);
        }
        ...
        public float RotationFloat
        {
            get
            {
                ...
                if (gameVersion >= GameVersion.v1_0_944_2_Steam)
                    return NativeMemory.ReadFloat(address + 0x58);

                var offset = gameVersion >= GameVersion.v1_0_463_1_Steam ? 0x58 : 0x54;
                return (float)NativeMemory.ReadInt16(address + offset);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (gameVersion >= GameVersion.v1_0_944_2_Steam)
                {
                    NativeMemory.WriteFloat(address + 0x58, valueNormalized);
                    return;
                }

                var offset = gameVersion >= GameVersion.v1_0_463_1_Steam ? 0x58 : 0x54;
                NativeMemory.WriteInt16(address + offset, (short)valueNormalized);
        ...
        public float Scale
        {
            set => Call(Hash.SET_BLIP_SCALE, Handle, value);
        }
        ...
        public float ScaleX
        {
            get
            {
                ...
                return NativeMemory.ReadFloat(address + 0x50);
            }
            set
            {
                var address = MemoryAddress;
                ...
                NativeMemory.WriteFloat(address + 0x50, value);
            }
        }
        ...
        public float ScaleY
        {
            get
            {
                ...
                return Game.Version >= GameVersion.v1_0_463_1_Steam
                    ? NativeMemory.ReadFloat(address + 0x54)
                    : NativeMemory.ReadFloat(address + 0x50);
            }
            set
            {
                var address = MemoryAddress;
                ...
                if (Game.Version >= GameVersion.v1_0_463_1_Steam)
                    NativeMemory.WriteFloat(address + 0x54, value);
                else
                    NativeMemory.WriteFloat(address + 0x50, value);
            }
        }
        ...
        public int FlashInterval
        {
            get
            {
                ...
                return NativeMemory.ReadInt16(address + 0x44);
            }
            set => Call(Hash.SET_BLIP_FLASH_INTERVAL, Handle, value);
        }
        ...
        public int FlashTimeLeft
        {
            get
            {
                ...
                int returnValue = NativeMemory.ReadInt16(address + 0x44);
            ...
            set => Call(Hash.SET_BLIP_FLASH_TIMER, Handle, value);
        }
        ...
        {
            get => Entity.FromHandle(Call<int>(Hash.GET_BLIP_INFO_ID_ENTITY_INDEX, Handle));
        }
        ...
        public bool ShowRoute
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 0x20, 4);
            }
            set => Call(Hash.SET_BLIP_ROUTE, Handle, value);
        }
        ...
        public bool ShowsDollarSign
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 0x20, 16);
            }
            set => Call(Hash.SHOW_TICK_ON_BLIP, Handle, value);
        }
        ...
        public bool ShowsHeadingIndicator
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 0x20, 17);
            }
            set => Call(Hash.SHOW_HEADING_INDICATOR_ON_BLIP, Handle, value);
        }
        ...
        public bool ShowsOutlineIndicator
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 0x20, 18);
            }
            set => Call(Hash.SHOW_HEADING_INDICATOR_ON_BLIP, Handle, value);
        }
        ...
        public bool ShowsFriendIndicator
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 0x20, 19);
            }
            set => Call(Hash.SHOW_FRIEND_INDICATOR_ON_BLIP, Handle, value);
        }
        ...
        public bool ShowsCrewIndicator
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 0x20, 20);
            }
            set => Call(Hash.SHOW_CREW_INDICATOR_ON_BLIP, Handle, value);
        }
        ...
        {
            set => Call(Hash.SET_BLIP_AS_FRIENDLY, Handle, value);
        }
        ...
        {
            get => Call<bool>(Hash.IS_BLIP_FLASHING, Handle);
            set => Call(Hash.SET_BLIP_FLASHES, Handle, value);
        }
        ...
        {
            get => Call<bool>(Hash.IS_BLIP_ON_MINIMAP, Handle);
        }
        ...
        {
            get => Call<bool>(Hash.IS_BLIP_SHORT_RANGE, Handle);
            set => Call(Hash.SET_BLIP_AS_SHORT_RANGE, Handle, value);
        }
        ...
        public bool IsHiddenOnLegend
        {
            get
            {
                ...
                return NativeMemory.IsBitSet(address + 0x20, 14);
            }
            set => Call(Hash.SET_BLIP_HIDDEN_ON_LEGEND, Handle, value);
        }
        ...
        public string GetAppropriateName()
        {
            ...
            // Assume the name string pointer is accessible, since the game will crash if the name length is not 0 and does not have access to the name string pointer
            return nameLength != 0
                ? PtrToStringUTF8(NativeMemory.ReadAddress(address + 0x28))
                : Game.GetLocalizedString(NativeMemory.ReadInt32(address + 0x38));
        }
        ...
        {
            return Call<bool>(Hash.DOES_BLIP_EXIST, Handle);
        }
