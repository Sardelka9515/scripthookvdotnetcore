...
namespace GTA.NaturalMotion
{
    ...
    public class Message
    {
        ...
        private static readonly Dictionary<string, (int value, Type type)> _stopArgument = new()
            { { "start", (0, typeof(bool)) } };
        ...
        {
            NativeMemory.SendEuphoriaMessage(target.Handle, _message, _stopArgument, null);
        }
        ...
        public void SendTo(Ped target)
        {
            ...
            if (!NativeMemory.IsTaskNMScriptControlOrEventSwitch2NMActive(target.MemoryAddress))
            {
                ...
                Call(Hash.SET_PED_TO_RAGDOLL, target.Handle, 10000, -1, 1, 1, 1, 0);
            }

            SetArgument("start", true);
            NativeMemory.SendEuphoriaMessage(target.Handle, _message, _boolIntFloatArguments,
                _stringVector3ArrayArguments);
        }
        ...
        public void SendTo(Ped target, int duration)
        {
            ...
            Call(Hash.SET_PED_TO_RAGDOLL, target.Handle, 10000, duration, 1, 1, 1, 0);
            SendTo(target);
        }
