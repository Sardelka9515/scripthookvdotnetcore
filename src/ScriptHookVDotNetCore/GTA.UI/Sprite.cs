...
namespace GTA.UI
{
    ...
    public class Sprite : ISpriteElement, IDisposable
    {
        ...
        {
            if (!Enabled || !Call<bool>(Hash.HAS_STREAMED_TEXTURE_DICT_LOADED, _textureDict))
            {
                return;
            }
            ...
            Function.Call(Hash.DRAW_SPRITE, _pinnedDict, _pinnedName, positionX, positionY, scaleX, scaleY, Rotation,
