...
namespace GTA.UI
{
    ...
    public static class Notification
    {
        ...
        static readonly string[] iconNames = new string[]
        {
            ...
            "CHAR_BARRY", "CHAR_BEVERLY", "CHAR_BIKESITE", "CHAR_BLANK_ENTRY", "CHAR_BLIMP", "CHAR_BLOCKED",
            "CHAR_BOATSITE",
            ...
            "CHAR_OMEGA", "CHAR_ONEIL", "CHAR_ORTEGA", "CHAR_OSCAR", "CHAR_PATRICIA", "CHAR_PEGASUS_DELIVERY",
            "CHAR_PLANESITE",
            "CHAR_PROPERTY_ARMS_TRAFFICKING", "CHAR_PROPERTY_BAR_AIRPORT", "CHAR_PROPERTY_BAR_BAYVIEW",
            "CHAR_PROPERTY_BAR_CAFE_ROJO", "CHAR_PROPERTY_BAR_COCKOTOOS", "CHAR_PROPERTY_BAR_ECLIPSE",
            "CHAR_PROPERTY_BAR_FES",
            "CHAR_PROPERTY_BAR_HEN_HOUSE", "CHAR_PROPERTY_BAR_HI_MEN", "CHAR_PROPERTY_BAR_HOOKIES",
            "CHAR_PROPERTY_BAR_IRISH",
            "CHAR_PROPERTY_BAR_LES_BIANCO", "CHAR_PROPERTY_BAR_MIRROR_PARK", "CHAR_PROPERTY_BAR_PITCHERS",
            "CHAR_PROPERTY_BAR_SINGLETONS",
            "CHAR_PROPERTY_BAR_TEQUILALA", "CHAR_PROPERTY_BAR_UNBRANDED", "CHAR_PROPERTY_CAR_MOD_SHOP",
        ...
        public static int Show(string message, bool blinking = false)
        {
            ...
            return Call<int>(Hash.END_TEXT_COMMAND_THEFEED_POST_TICKER, blinking, true);
        }
        ...
        /// <param name="blinking">if set to <see langword="true" /> the notification will blink.</param>
        /// <returns>The handle of the <see cref="Notification"/> which can be used to hide it using <see cref="Notification.Hide(int)"/>.</returns>
        public static int Show(NotificationIcon icon, string sender, string subject, string message,
            bool fadeIn = false, bool blinking = false)
        {
            string iconName = iconNames[(int)icon];

            Function.Call(Hash.BEGIN_TEXT_COMMAND_THEFEED_POST, CellEmailBcon);
            PushLongString(message);
            Call(Hash.END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT, iconName, iconName, fadeIn, 1, sender, subject);
        ...
        {
            Call(Hash.THEFEED_REMOVE_ITEM, handle);
        }
    }
}